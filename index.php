...
<span id = "comitteeComps" style="cursor:pointer;background: rgba(207,229,230,0.8);" onclick="getPage('Comps')">
<img id="eve1" src="static/Icons_Final/Comps_Main.png"/>
</span>
<span id = "comitteeCivil" style="cursor:pointer;background: rgba(230,211,245,0.8);" onclick="getPage('Civil')">
<img id="eve2" src="static/Icons_Final/civilmain.png"/>
</span>
<span id = "comitteeMaterials" style="cursor:pointer;background: rgba(233,207,201,0.8);" onclick="getPage('Materials')">
<img id="eve3" src="static/Icons_Final/Metamain.png"/>
</span>
<span id = "comitteeBiz" style="cursor:pointer;background: rgba(248,232,246,0.8);" onclick="getPage('Biz')">
<img id="eve4" src="static/Icons_Final/BIZ.png"/>
</span>
<span id = "comitteeChemical" style="cursor:pointer;background: rgba(232,225,223,0.8);" onclick="getPage('Chemical')">
<img id="eve5" src="static/Icons_Final/chemmain.png"/>
</span>
<span id = "comitteeTronix" style="cursor:pointer;background: rgba(222,204,232,0.8);" onclick="getPage('Tronix')">
<img id="eve6" src="static/Icons_Final/tronix.png"/>
</span>
<span id = "comitteeSce" style="cursor:pointer;background: rgba(216,239,229,0.8);" onclick="getPage('Sce')">
<img id="eve7" src="static/Icons_Final/Sce.png"/>
</span>
<span id = "comitteeMining" style="cursor:pointer;background: rgba(208,229,226,0.8);" onclick="getPage('Mining')">
<img id="eve8" src="static/Icons_Final/mining.png"/>
</span>
<span id = "comitteeMechanical" style="cursor:pointer;background: rgba(237,217,213,0.8);" onclick="getPage('Mechanical')">
<img id="eve9" src="static/Icons_Final/mech.png"/>
</span>
<span id = "comitteeAstronomy" style="cursor:pointer;background: rgba(222,241,215,0.8);" onclick="getPage('Astronomy')">
<img id="eve10" src="static/Icons_Final/astro.png"/>
</span>
<span id = "comitteeGaming" style="cursor:pointer;background: rgba(233,211,212,0.8);" onclick="getPage('Gaming')">
<img id="eve11" src="static/Icons_Final/gaming.png"/>
</span>
<span id = "comitteeGeneral" style="cursor:pointer;background: rgba(240,230,247,0.8);" onclick="getPage('General')">
<img id="eve12" src="static/Icons_Final/GeneralEvents.png"/>
</span>
<span id = "comitteeBlue_Print" style="cursor:pointer;background: rgba(213,210,232,0.8);" onclick="getPage('Blue_Print')">
<img id="eve13" src="static/Icons_Final/BluePrint.png"/>
</span>
<span id = "comitteeMockstock" style="cursor:pointer;background: rgba(229,247,221,0.8);" onclick="getPage('Mockstock')">
...
<table>
<tr>
<td><span id='blockGen10' onclick='getPage("Megapixel")' style='cursor:pointer;width: 250px;background: rgba(238,232,215,0.8);'><img src='static/Icons_Final/megapixel.png'/></span></td>
<td><span id='blockGen11' onclick='getPage("Blitzkrieg")' style='cursor:pointer;width: 250px;background: rgba(216,207,241,0.8);'><img src='static/Icons_Final/blitzkrieg.png'/></span></td>
<td><span id='blockGen12' onclick='getPage("Dance_Dance_Revolution")' style='cursor:pointer;width: 250px;background: rgba(240,226,202,0.8);'><img src='static/Icons_Final/Dance.jpg'/></span></td>
<td><span id='blockGen13' onclick='getPage("Psychedelic_Room")' style='cursor:pointer;width: 250px;background: rgba(246,246,236,0.8);'><img src='static/Icons_Final/PsychRoom.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen14' onclick='getPage("Arcade_Room")' style='cursor:pointer;width: 250px;background: rgba(244,234,204,0.8);'><img src='static/Icons_Final/arcade.jpg'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen20' onclick='getPage("Inscription")' style='cursor:pointer;width: 250px;background: rgba(227,241,218,0.8);'><img src='static/Icons_Final/INSCRIPTION.png'/></span></td>
<td><span id='blockGen21' onclick='getPage("Kode_Kombat")' style='cursor:pointer;width: 250px;background: rgba(225,206,242,0.8);'><img src='static/Icons_Final/CODE_KOMBAT.png'/></span></td>
<td><span id='blockGen22' onclick='getPage("Rectify")' style='cursor:pointer;width: 250px;background: rgba(245,203,200,0.8);'><img src='static/Icons_Final/RECTIFY.png'/></span></td>
<td><span id='blockGen23' onclick='getPage("Marathon")' style='cursor:pointer;width: 250px;background: rgba(242,218,240,0.8);'><img src='static/Icons_Final/marathon_final.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen24' onclick='getPage("Virtual_Bounty")' style='cursor:pointer;width: 250px;background: rgba(223,219,226,0.8);'><img src='static/Icons_Final/VIRTUAL_BOUNTY2.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen30' onclick='getPage("COLOSSUS")' style='cursor:pointer;width: 250px;background: rgba(218,249,225,0.8);'><img src='static/Icons_Final/Colossus.png'/></span></td>
<td><span id='blockGen31' onclick='getPage("FantastiCity")' style='cursor:pointer;width: 250px;background: rgba(222,236,215,0.8);'><img src='static/Icons_Final/fantasticity2.png'/></span></td>
<td><span id='blockGen32' onclick='getPage("Architect")' style='cursor:pointer;width: 250px;background: rgba(220,249,217,0.8);'><img src='static/Icons_Final/Architect2.png'/></span></td>
<td><span id='blockGen33' onclick='getPage("Mindbend")' style='cursor:pointer;width: 250px;background: rgba(238,243,204,0.8);'><img src='static/Icons_Final/mindbend.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen34' onclick='getPage("Nirvahana")' style='cursor:pointer;width: 250px;background: rgba(220,213,209,0.8);'><img src='static/Icons_Final/Nirvana.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen44' onclick='getPage("MetaMagic")' style='cursor:pointer;width: 250px;background: rgba(227,244,219,0.8);'><img src='static/Icons_Final/MetaMagic.png'/></span></td>
<td><span id='blockGen45' onclick='getPage("mindBend")' style='cursor:pointer;width: 250px;background: rgba(244,211,221,0.8);'><img src='static/Icons_Final/mindbend.png'/></span></td>
<td><span id='blockGen46' onclick='getPage("SEM_and_TEM_Expo")' style='cursor:pointer;width: 250px;background: rgba(217,221,236,0.8);'><img src='static/Icons_Final/SEMTEMExpo.png'/></span></td>
<td><span id='blockGen47' onclick='getPage("SEM_Photography_Contest")' style='cursor:pointer;width: 250px;background: rgba(226,235,225,0.8);'><img src='static/Icons_Final/SEMphotography.png'/></span></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen51' onclick='getPage("Case_Study_challenge")' style='cursor:pointer;width: 250px;background: rgba(224,200,201,0.8);'><img src='static/Icons_Final/casestudychallenge.png'/></span></td>
<td><span id='blockGen52' onclick='getPage("Green_Inovation_Challenge")' style='cursor:pointer;width: 250px;background: rgba(235,229,239,0.8);'><img src='static/Icons_Final/Green_Innovation_Challenge.png'/></span></td>
<td><span id='blockGen53' onclick='getPage("Campus_Social_Innovision_Challenge")' style='cursor:pointer;width: 250px;background: rgba(210,212,235,0.8);'><img src='static/Icons_Final/campussocialinnovation.png'/></span></td>
<td><button id='blockGen54' class='button1' onclick='getPage("Adventure")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(231,249,236,0.8);'><h1 style='text-align:center;font-family: acens;'>Adventure</h1></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen63' onclick='getPage("Chemical_Breakdown")' style='cursor:pointer;width: 250px;background: rgba(224,240,234,0.8);'><img src='static/Icons_Final/Chemical_Breakdown.png'/></span></td>
<td><span id='blockGen64' onclick='getPage("Industry_Defined_Problem")' style='cursor:pointer;width: 250px;background: rgba(243,247,208,0.8);'><img src='static/Icons_Final/IDP.png'/></span></td>
<td><span id='blockGen65' onclick='getPage("The_Portal")' style='cursor:pointer;width: 250px;background: rgba(223,243,205,0.8);'><img src='static/Icons_Final/the_portal.png'/></span></td>
<td><button id='blockGen66' class='button1' onclick='getPage("Contraption")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(236,235,228,0.8);'><h1 style='text-align:center;font-family: acens;'>Contraption</h1></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen73' onclick='getPage("TrailBlazer")' style='cursor:pointer;width: 250px;background: rgba(235,219,246,0.8);'><img src='static/Icons_Final/trailblazer.png'/></span></td>
<td><span id='blockGen74' onclick='getPage("Automata")' style='cursor:pointer;width: 250px;background: rgba(205,221,240,0.8);'><img src='static/Icons_Final/AUTOMATA_NEW.png'/></span></td>
<td><span id='blockGen75' onclick='getPage("Simplicity")' style='cursor:pointer;width: 250px;background: rgba(203,209,238,0.8);'><img src='static/Icons_Final/SIMPLICITY.png'/></span></td>
<td><span id='blockGen76' onclick='getPage("Trade_OFF")' style='cursor:pointer;width: 250px;background: rgba(236,238,210,0.8);'><img src='static/Icons_Final/trade_off.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen77' onclick='getPage("FoxHunt")' style='cursor:pointer;width: 250px;background: rgba(216,227,202,0.8);'><img src='static/Icons_Final/foxxhunt.png'/></span></td>
<td><span id='blockGen78' onclick='getPage("Symphony")' style='cursor:pointer;width: 250px;background: rgba(242,218,242,0.8);'><img src='static/Icons_Final/Symphony.png'/></span></td>
<td><span id='blockGen79' onclick='getPage("Waltz")' style='cursor:pointer;width: 250px;background: rgba(230,200,228,0.8);'><img src='static/Icons_Final/Waltz.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen83' onclick='getPage("The_Last_Word")' style='cursor:pointer;width: 250px;background: rgba(222,235,241,0.8);'><img src='static/Icons_Final/lastword.png'/></span></td>
<td><span id='blockGen84' onclick='getPage("Sparsh")' style='cursor:pointer;width: 250px;background: rgba(244,249,218,0.8);'><img src='static/Icons_Final/saprsh.png'/></span></td>
<td><span id='blockGen85' onclick='getPage("Sky_Lanterns")' style='cursor:pointer;width: 250px;background: rgba(208,245,230,0.8);'><img src='static/Icons_Final/sky_lantern.png'/></span></td>
<td><span id='blockGen86' onclick='getPage("Green_Inovation_Challenge")' style='cursor:pointer;width: 250px;background: rgba(205,208,211,0.8);'><img src='static/Icons_Final/Green_Innovation_Challenge.png'/></span></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen93' onclick='getPage("Mine_Rush")' style='cursor:pointer;width: 250px;background: rgba(240,224,233,0.8);'><img src='static/Icons_Final/Mine_Rush.png'/></span></td>
<td><span id='blockGen94' onclick='getPage("Adverse_Mining_Problem")' style='cursor:pointer;width: 250px;background: rgba(214,205,201,0.8);'><img src='static/Icons_Final/adverse_mining.png'/></span></td>
<td><span id='blockGen95' onclick='getPage("Mine_Quest")' style='cursor:pointer;width: 250px;background: rgba(208,220,208,0.8);'><img src='static/Icons_Final/Mine_Quest.png'/></span></td>
<td><span id='blockGen96' onclick='getPage("Innovating_Mining")' style='cursor:pointer;width: 250px;background: rgba(244,200,224,0.8);'><img src='static/Icons_Final/mining_innovation.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen97' onclick='getPage("Blast_Mine_Ventilation")' style='cursor:pointer;width: 250px;background: rgba(214,236,248,0.8);'><img src='static/Icons_Final/blast_mine_ventilation.png'/></span></td>
<td><span id='blockGen98' onclick='getPage("Hang-Man")' style='cursor:pointer;width: 250px;background: rgba(207,232,207,0.8);'><img src='static/Icons_Final/HANGMAN_MAIN.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen109' onclick='getPage("Robowars")' style='cursor:pointer;width: 250px;background: rgba(228,216,220,0.8);'><img src='static/Icons_Final/RoboWars.png'/></span></td>
<td><span id='blockGen110' onclick='getPage("PerfectMachine")' style='cursor:pointer;width: 250px;background: rgba(202,205,213,0.8);'><img src='static/Icons_Final/PerfectMachine.png'/></span></td>
<td><span id='blockGen111' onclick='getPage("wrightflight")' style='cursor:pointer;width: 250px;background: rgba(203,222,222,0.8);'><img src='static/Icons_Final/WrightFlight.png'/></span></td>
<td><span id='blockGen112' onclick='getPage("Proteus")' style='cursor:pointer;width: 250px;background: rgba(217,225,210,0.8);'><img src='static/Icons_Final/Proteus.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen113' onclick='getPage("Velocity")' style='cursor:pointer;width: 250px;background: rgba(214,244,226,0.8);'><img src='static/Icons_Final/Velocity.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen123' onclick='getPage("AstroTalk")' style='cursor:pointer;width: 250px;background: rgba(221,226,225,0.8);'><img src='static/Icons_Final/astro_talk.png'/></span></td>
<td><span id='blockGen124' onclick='getPage("StarWars")' style='cursor:pointer;width: 250px;background: rgba(233,212,246,0.8);'><img src='static/Icons_Final/starwars.png'/></span></td>
<td><span id='blockGen125' onclick='getPage("BeyondEarth")' style='cursor:pointer;width: 250px;background: rgba(247,218,217,0.8);'><img src='static/Icons_Final/Beyond_Earth.png'/></span></td>
<td><span id='blockGen126' onclick='getPage("Exhibits")' style='cursor:pointer;width: 250px;background: rgba(217,221,234,0.8);'><img src='static/Icons_Final/exhibitions.jpg'/></span></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen133' onclick='getPage("Aoe")' style='cursor:pointer;width: 250px;background: rgba(213,214,204,0.8);'><img src='static/Icons_Final/aoe2.jpg'/></span></td>
<td><span id='blockGen134' onclick='getPage("CounterStrike")' style='cursor:pointer;width: 250px;background: rgba(242,247,215,0.8);'><img src='static/Icons_Final/COUNTERSTRIKE.png'/></span></td>
<td><span id='blockGen135' onclick='getPage("dota")' style='cursor:pointer;width: 250px;background: rgba(249,219,235,0.8);'><img src='static/Icons_Final/dOTA.png'/></span></td>
<td><span id='blockGen136' onclick='getPage("Fifa")' style='cursor:pointer;width: 250px;background: rgba(246,246,218,0.8);'><img src='static/Icons_Final/fifa.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen137' onclick='getPage("NFS")' style='cursor:pointer;width: 250px;background: rgba(230,218,244,0.8);'><img src='static/Icons_Final/nfs.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen147' onclick='getPage("Ethical_Hacking_by_TechDefence")' style='cursor:pointer;width: 250px;background: rgba(200,241,249,0.8);'><img src='static/Icons_Final/HACKING.png'/></span></td>
<td><span id='blockGen148' onclick='getPage("Android_Application_Development")' style='cursor:pointer;width: 250px;background: rgba(234,231,217,0.8);'><img src='static/Icons_Final/Android.png'/></span></td>
<td><span id='blockGen149' onclick='getPage("3D_Photography")' style='cursor:pointer;width: 250px;background: rgba(227,247,213,0.8);'><img src='static/Icons_Final/3d_photo.jpg'/></span></td>
<td><span id='blockGen150' onclick='getPage("Bridge_Design_and_Fabrication")' style='cursor:pointer;width: 250px;background: rgba(245,235,226,0.8);'><img src='static/Icons_Final/Bridge_design.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen151' onclick='getPage("RC_Aircraft_Design_and_Fabrication")' style='cursor:pointer;width: 250px;background: rgba(205,216,244,0.8);'><img src='static/Icons_Final/RC_Aircraft.png'/></span></td>
<td><span id='blockGen152' onclick='getPage("Augmented_Reality")' style='cursor:pointer;width: 250px;background: rgba(246,219,245,0.8);'><img src='static/Icons_Final/AUGMENTED.png'/></span></td>
<td><span id='blockGen153' onclick='getPage("Humanoid_Robot")' style='cursor:pointer;width: 250px;background: rgba(248,204,224,0.8);'><img src='static/Icons_Final/ROBOTICS.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen161' onclick='getPage("Simplineer")' style='cursor:pointer;width: 250px;background: rgba(215,225,228,0.8);'><img src='static/Icons_Final/SIMPLINEER.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<span id='blockGen162' style='background: rgba(228,247,210,0.8);'><img src="static/Icons_Final/megapixel.png" width='250px'/></span><br />
<span id='blockGen163' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,211,207,0.8);' onclick='getPage("Megapixel","Megapixel@Description")'><b>Description</b></span>
<span id='blockGen164' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(217,249,248,0.8);'><b>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen168' style='background: rgba(232,240,247,0.8);'><img src="static/Icons_Final/blitzkrieg.png" width='250px'/></span><br />
<span id='blockGen169' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(243,248,202,0.8);' onclick='getPage("Blitzkrieg","Blitzkrieg@Description")'><b>Description</b></span>
<span id='blockGen170' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(245,249,205,0.8);'><b>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen174' style='background: rgba(237,235,208,0.8);'><img src="static/Icons_Final/Dance.jpg" width='250px'/></span><br />
<span id='blockGen175' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,208,233,0.8);' onclick='getPage("Dance_Dance_Revolution","Dance_Dance_Revolution@Description")'><b>Description</b></span>
<span id='blockGen176' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(213,207,206,0.8);'><b>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen180' style='background: rgba(232,207,249,0.8);'><img src="static/Icons_Final/PsychRoom.png" width='250px'/></span><br />
<span id='blockGen181' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(237,204,222,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room@Light_Wall")'><b>Light_Wall</b></span>
<span id='blockGen182' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(236,207,207,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room@Decagon")'><b>Decagon</b></span>
<span id='blockGen183' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(221,241,224,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room@Waterfall")'><b>Waterfall</b></span>
<span id='blockGen184' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(227,228,212,0.8);'><b>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen194' style='background: rgba(239,240,244,0.8);'><img src="static/Icons_Final/arcade.jpg" width='250px'/></span><br />
<span id='blockGen195' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,208,243,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Agent_Dash")'><b>Agent_Dash</b></span>
<span id='blockGen196' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,202,221,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Labyrinth")'><b>Labyrinth</b></span>
<span id='blockGen197' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(228,233,213,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Pin_Ball")'><b>Pin_Ball</b></span>
<span id='blockGen198' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(202,242,217,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Temple_Run")'><b>Temple_Run</b></span>
<span id='blockGen199' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,203,233,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@ContraptioN")'><b>ContraptioN</b></span>
<span id='blockGen200' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,227,221,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Strongman")'><b>Strongman</b></span>
<span id='blockGen201' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,242,237,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Shadow_LED")'><b>Shadow_LED</b></span>
<span id='blockGen202' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(238,209,205,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Liquid_Light")'><b>Liquid_Light</b></span>
<span id='blockGen203' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(218,212,232,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Theremin")'><b>Theremin</b></span>
<span id='blockGen204' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(206,241,204,0.8);' onclick='getPage("Arcade_Room","Arcade_Room@Laser_Harp")'><b>Laser_Harp</b></span>
<span id='blockGen205' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(203,243,234,0.8);'><b>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen236' style='background: rgba(216,233,218,0.8);'><img src="static/Icons_Final/INSCRIPTION.png" width='250px'/></span><br />
<span id='blockGen237' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,234,212,0.8);' onclick='generateTeamRegForm("Inscription")'><b>Register</b></span>
<span id='blockGen238' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,211,204,0.8);' onclick='getPage("Inscription","Inscription@Description")'><b>Description</b></span>
<span id='blockGen239' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(228,212,218,0.8);'><b>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen243' style='background: rgba(247,205,230,0.8);'><img src="static/Icons_Final/CODE_KOMBAT.png" width='250px'/></span><br />
<span id='blockGen244' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,211,234,0.8);' onclick='generateTeamRegForm("Kode_Kombat")'><b>Register</b></span>
<span id='blockGen245' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(228,229,248,0.8);' onclick='getPage("Kode_Kombat","Kode_Kombat@Description")'><b>Description</b></span>
<span id='blockGen246' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(201,217,216,0.8);'><b>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideRectify'>
<span id='blockGen250' style='background: rgba(221,240,245,0.8);'><img src="static/Icons_Final/RECTIFY.png" width='250px'/></span><br />
<span id='blockGen251' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(227,219,242,0.8);' onclick='register_single_event(59)'><b>Register</b></span>
<span id='blockGen252' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(200,216,210,0.8);' onclick='getPage("Rectify","Rectify@Description")'><b>Description</b></span>
<span id='blockGen253' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(234,240,212,0.8);'><b>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen257' style='background: rgba(210,248,214,0.8);'><img src="static/Icons_Final/marathon_final.png" width='250px'/></span><br />
<span id='blockGen258' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(239,208,247,0.8);' onclick='generateTeamRegForm("Marathon")'><b>Register</b></span>
<span id='blockGen259' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(204,221,219,0.8);' onclick='getPage("Marathon","Marathon@Description")'><b>Description</b></span>
<span id='blockGen260' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(249,235,208,0.8);'><b>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen264' style='background: rgba(223,218,212,0.8);'><img src="static/Icons_Final/VIRTUAL_BOUNTY2.png" width='250px'/></span><br />
<span id='blockGen265' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(201,235,237,0.8);' onclick='register_single_event(56)'><b>Register</b></span>
<span id='blockGen266' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(245,205,215,0.8);' onclick='getPage("Virtual_Bounty","Virtual_Bounty@Description")'><b>Description</b></span>
<span id='blockGen267' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(228,217,242,0.8);'><b>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen271' style='background: rgba(237,219,202,0.8);'><img src="static/Icons_Final/Colossus.png" width='250px'/></span><br />
<span id='blockGen272' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,207,244,0.8);' onclick='register_single_event(42)'><b>Register</b></span>
<span id='blockGen273' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(210,210,207,0.8);' onclick='getPage("COLOSSUS","COLOSSUS@Description")'><b>Description</b></span>
<span id='blockGen274' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(221,219,231,0.8);'><b>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen278' style='background: rgba(218,202,203,0.8);'><img src="static/Icons_Final/fantasticity2.png" width='250px'/></span><br />
<span id='blockGen279' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,229,200,0.8);' onclick='register_single_event(41)'><b>Register</b></span>
<span id='blockGen280' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(206,247,203,0.8);' onclick='getPage("FantastiCity","FantastiCity@Description")'><b>Description</b></span>
<span id='blockGen281' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(247,237,234,0.8);'><b>Contact: B.THEJA<br/>+919480435585<br/>bnmtheja@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen285' style='background: rgba(244,237,233,0.8);'><img src="static/Icons_Final/Architect2.png" width='250px'/></span><br />
<span id='blockGen286' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(232,209,232,0.8);' onclick='register_single_event(43)'><b>Register</b></span>
<span id='blockGen287' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,244,207,0.8);' onclick='getPage("Architect","Architect@Home")'><b>Home</b></span>
<span id='blockGen288' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(220,205,221,0.8);' onclick='getPage("Architect","Architect@Description")'><b>Description</b></span>
<span id='blockGen289' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,220,203,0.8);' onclick='getPage("Architect","Architect@format")'><b>format</b></span>
<span id='blockGen290' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(248,220,219,0.8);' onclick='getPage("Architect","Architect@Eligibility")'><b>Eligibility</b></span>
<span id='blockGen291' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(244,248,217,0.8);'><b>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen304' style='background: rgba(226,231,245,0.8);'><img src="static/Icons_Final/mindbend.png" width='250px'/></span><br />
<span id='blockGen305' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(232,209,248,0.8);' onclick='register_single_event(62)'><b>Register</b></span>
<span id='blockGen306' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(245,200,227,0.8);' onclick='getPage("Mindbend","Mindbend@Description")'><b>Description</b></span>
<span id='blockGen307' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(235,209,243,0.8);' onclick='getPage("Mindbend","Mindbend@format")'><b>format</b></span>
<span id='blockGen308' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(239,221,223,0.8);' onclick='getPage("Mindbend","Mindbend@eligibility")'><b>eligibility</b></span>
<span id='blockGen309' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(221,203,238,0.8);'><b>Contact: B. THEJA <br/>+919480435585 <br/>bnmtheja@gmail.com <br/>Padmini M <br/>+918123463865 <br/>pm27178@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen319' style='background: rgba(200,245,240,0.8);'><img src="static/Icons_Final/Nirvana.png" width='250px'/></span><br />
<span id='blockGen320' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,249,206,0.8);' onclick='register_single_event(44)'><b>Register</b></span>
<span id='blockGen321' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(244,230,208,0.8);' onclick='getPage("Nirvahana","Nirvahana@Home")'><b>Home</b></span>
<span id='blockGen322' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(249,235,217,0.8);'><b>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Niveditha.J<br/>+917795543699<br/>niveditha811@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen326' style='background: rgba(212,218,220,0.8);'><img src="static/Icons_Final/Techspeak.png" width='250px'/></span><br />
<span id='blockGen327' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(236,201,227,0.8);' onclick='getPage("Tech_Speak","Tech_Speak@Description")'><b>Description</b></span>
<span id='blockGen328' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(216,208,209,0.8);' onclick='getPage("Tech_Speak","Tech_Speak@Schedule")'><b>Schedule</b></span>
<span id='blockGen329' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(212,240,223,0.8);'><b>Contact: Aashish Mane - +91 9945049097</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen336' style='background: rgba(225,228,221,0.8);'><img src="static/Icons_Final/MetaMagic.png" width='250px'/></span><br />
<span id='blockGen337' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(215,212,232,0.8);' onclick='register_single_event(9)'><b>Register</b></span>
<span id='blockGen338' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(204,239,245,0.8);' onclick='getPage("MetaMagic","MetaMagic@Description")'><b>Description</b></span>
<span id='blockGen339' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(248,236,236,0.8);'><b>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sidemindBend'>
<span id='blockGen343' style='background: rgba(231,208,233,0.8);'><img src="static/Icons_Final/mindbend.png" width='250px'/></span><br />
<span id='blockGen344' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,245,245,0.8);' onclick='generateTeamRegForm("mindBend")'><b>Register</b></span>
<span id='blockGen345' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,220,245,0.8);' onclick='getPage("mindBend","mindBend@Description")'><b>Description</b></span>
<span id='blockGen346' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(200,206,246,0.8);'><b>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupmindBend">
...
<span id='blockGen350' style='background: rgba(219,208,203,0.8);'><img src="static/Icons_Final/SEMTEMExpo.png" width='250px'/></span><br />
<span id='blockGen351' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,243,231,0.8);' onclick='register_single_event(8)'><b>Register</b></span>
<span id='blockGen352' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(200,241,228,0.8);' onclick='getPage("SEM_and_TEM_Expo","SEM_and_TEM_Expo@Description")'><b>Description</b></span>
<span id='blockGen353' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(248,225,223,0.8);'><b>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen357' style='background: rgba(235,229,200,0.8);'><img src="static/Icons_Final/SEMphotography.png" width='250px'/></span><br />
<span id='blockGen358' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,234,218,0.8);' onclick='register_single_event(10)'><b>Register</b></span>
<span id='blockGen359' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,202,249,0.8);' onclick='getPage("SEM_Photography_Contest","SEM_Photography_Contest@Description")'><b>Description</b></span>
<span id='blockGen360' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(200,233,243,0.8);' onclick='getPage("SEM_Photography_Contest","SEM_Photography_Contest@Submissiion Format")'><b>Submissiion Format</b></span>
<span id='blockGen361' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(209,221,230,0.8);'><b>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen368' style='background: rgba(231,216,209,0.8);'><img src="static/Icons_Final/casestudychallenge.png" width='250px'/></span><br />
<span id='blockGen369' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,202,225,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Description")'><b>Description</b></span>
<span id='blockGen370' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,218,224,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Introduction")'><b>Introduction</b></span>
<span id='blockGen371' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(226,247,203,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Agenda")'><b>Agenda</b></span>
<span id='blockGen372' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(226,249,237,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Case 1")'><b>Case 1</b></span>
<span id='blockGen373' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(242,217,215,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Case 2")'><b>Case 2</b></span>
<span id='blockGen374' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,207,200,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Case 3")'><b>Case 3</b></span>
<span id='blockGen375' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,210,228,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge@Register")'><b>Register</b></span>
<span id='blockGen376' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(231,238,235,0.8);'><b>Contact: Neetesh Hegde <br/> 9483647944</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen398' style='background: rgba(245,238,232,0.8);'><img src="static/Icons_Final/Green_Innovation_Challenge.png" width='250px'/></span><br />
<span id='blockGen399' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(248,229,222,0.8);' onclick='register_single_event(11)'><b>Register</b></span>
<span id='blockGen400' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(237,242,233,0.8);' onclick='getPage("Product_Design_Challenge","Product_Design_Challenge@Description")'><b>Description</b></span>
<span id='blockGen401' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(242,202,246,0.8);'><b>Contact: Neetesh Hegde <br/> 9483647944</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen405' style='background: rgba(205,200,205,0.8);'><img src="static/Icons_Final/campussocialinnovation.png" width='250px'/></span><br />
<span id='blockGen406' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(210,229,203,0.8);' onclick='register_single_event(12)'><b>Register</b></span>
<span id='blockGen407' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(236,249,231,0.8);' onclick='getPage("Campus_Social_Innovision_Challenge","Campus_Social_Innovision_Challenge@Description")'><b>Description</b></span>
<span id='blockGen408' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(220,230,237,0.8);'><b>Contact: Asmita Moon <br/>9986818125 </b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen412'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(220,224,205,0.8);'><h1 style='text-align:center;font-family: acens;'>Adventure</h1></button></span><br />
<span id='blockGen413' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(233,233,237,0.8);' onclick='register_single_event(71)'><b>Register</b></span>
<span id='blockGen414' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,233,209,0.8);' onclick='getPage("Adventure","Adventure@Description")'><b>Description</b></span>
<span id='blockGen415' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(222,210,228,0.8);' onclick='getPage("Adventure","Adventure@problemstatement")'><b>problemstatement</b></span>
<span id='blockGen416' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(215,215,244,0.8);'><b>Contact: Neetesh Hegde <br/> 9483647944</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen423' style='background: rgba(244,247,229,0.8);'><img src="static/Icons_Final/Chemical_Breakdown.png" width='250px'/></span><br />
<span id='blockGen424' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(236,230,235,0.8);' onclick='register_single_event(34)'><b>Register</b></span>
<span id='blockGen425' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(220,228,221,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown@Introduction")'><b>Introduction</b></span>
<span id='blockGen426' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,200,225,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown@rules")'><b>rules</b></span>
<span id='blockGen427' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(207,201,243,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown@rounds")'><b>rounds</b></span>
<span id='blockGen428' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(225,214,223,0.8);'><b>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen438' style='background: rgba(209,233,213,0.8);'><img src="static/Icons_Final/IDP.png" width='250px'/></span><br />
<span id='blockGen439' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(222,210,208,0.8);' onclick='register_single_event(32)'><b>Register</b></span>
<span id='blockGen440' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(218,216,243,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem@Description")'><b>Description</b></span>
<span id='blockGen441' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,242,245,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem@Rounds")'><b>Rounds</b></span>
<span id='blockGen442' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(227,223,213,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem@Rules_and_Regulations")'><b>Rules_and_Regulations</b></span>
<span id='blockGen443' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,238,208,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem@Problem Statement")'><b>Problem Statement</b></span>
<span id='blockGen444' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(244,220,249,0.8);'><b>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen457' style='background: rgba(210,219,235,0.8);'><img src="static/Icons_Final/the_portal.png" width='250px'/></span><br />
<span id='blockGen458' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,239,217,0.8);' onclick='register_single_event(33)'><b>Register</b></span>
<span id='blockGen459' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,220,214,0.8);' onclick='getPage("The_Portal","The_Portal@Description")'><b>Description</b></span>
<span id='blockGen460' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,232,224,0.8);' onclick='getPage("The_Portal","The_Portal@Round 1")'><b>Round 1</b></span>
<span id='blockGen461' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,205,241,0.8);' onclick='getPage("The_Portal","The_Portal@Round 2")'><b>Round 2</b></span>
<span id='blockGen462' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(220,216,211,0.8);' onclick='getPage("The_Portal","The_Portal@FAQ")'><b>FAQ</b></span>
<span id='blockGen463' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(242,209,243,0.8);'><b>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen476'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(200,222,249,0.8);'><h1 style='text-align:center;font-family: acens;'>Contraption</h1></button></span><br />
<span id='blockGen477' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,211,247,0.8);' onclick='generateTeamRegForm("Contraption")'><b>Register</b></span>
<span id='blockGen478' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(204,227,223,0.8);' onclick='getPage("Contraption","Contraption@Introduction")'><b>Introduction</b></span>
<span id='blockGen479' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,217,229,0.8);' onclick='getPage("Contraption","Contraption@Problem Statement")'><b>Problem Statement</b></span>
<span id='blockGen480' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,221,213,0.8);' onclick='getPage("Contraption","Contraption@Rules")'><b>Rules</b></span>
<span id='blockGen481' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(228,209,224,0.8);'><b>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen491' style='background: rgba(225,208,246,0.8);'><img src="static/Icons_Final/trailblazer.png" width='250px'/></span><br />
<span id='blockGen492' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(218,231,221,0.8);' onclick='generateTeamRegForm("TrailBlazer")'><b>Register</b></span>
<span id='blockGen493' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(204,221,229,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@Description")'><b>Description</b></span>
<span id='blockGen494' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,225,216,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@goal")'><b>goal</b></span>
<span id='blockGen495' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,223,211,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@botspecs")'><b>botspecs</b></span>
<span id='blockGen496' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,210,224,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@OtherDetails")'><b>OtherDetails</b></span>
<span id='blockGen497' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,248,203,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@ContestProcedure")'><b>ContestProcedure</b></span>
<span id='blockGen498' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,243,200,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@samplearena")'><b>samplearena</b></span>
<span id='blockGen499' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(213,230,236,0.8);' onclick='getPage("TrailBlazer","TrailBlazer@Arena")'><b>Arena</b></span>
<span id='blockGen500' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(223,233,213,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/> nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen522' style='background: rgba(236,218,220,0.8);'><img src="static/Icons_Final/AUTOMATA_NEW.png" width='250px'/></span><br />
<span id='blockGen523' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(234,227,229,0.8);' onclick='generateTeamRegForm("Automata")'><b>Register</b></span>
<span id='blockGen524' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(223,214,239,0.8);' onclick='getPage("Automata","Automata@Arena")'><b>Arena</b></span>
<span id='blockGen525' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,238,248,0.8);' onclick='getPage("Automata","Automata@Description")'><b>Description</b></span>
<span id='blockGen526' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,235,211,0.8);' onclick='getPage("Automata","Automata@Scoring Criteria")'><b>Scoring Criteria</b></span>
<span id='blockGen527' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(238,224,248,0.8);' onclick='getPage("Automata","Automata@download")'><b>download</b></span>
<span id='blockGen528' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(233,242,209,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/> nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen541' style='background: rgba(206,230,246,0.8);'><img src="static/Icons_Final/SIMPLICITY.png" width='250px'/></span><br />
<span id='blockGen542' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(222,233,235,0.8);' onclick='register_single_event(15)'><b>Register</b></span>
<span id='blockGen543' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,247,234,0.8);' onclick='getPage("Simplicity","Simplicity@Description")'><b>Description</b></span>
<span id='blockGen544' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(211,233,240,0.8);' onclick='getPage("Simplicity","Simplicity@EVENT FORMAT AND RULES")'><b>EVENT FORMAT AND RULES</b></span>
<span id='blockGen545' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,211,219,0.8);' onclick='getPage("Simplicity","Simplicity@SCORING CRITERIA")'><b>SCORING CRITERIA</b></span>
<span id='blockGen546' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(208,237,207,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen556' style='background: rgba(230,234,225,0.8);'><img src="static/Icons_Final/trade_off.png" width='250px'/></span><br />
<span id='blockGen557' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,215,243,0.8);' onclick='register_single_event(17)'><b>Register</b></span>
<span id='blockGen558' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,220,243,0.8);' onclick='getPage("Trade_OFF","Trade_OFF@Description")'><b>Description</b></span>
<span id='blockGen559' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(245,227,230,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideFoxHunt'>
<span id='blockGen563' style='background: rgba(216,228,202,0.8);'><img src="static/Icons_Final/foxxhunt.png" width='250px'/></span><br />
<span id='blockGen564' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,229,205,0.8);' onclick='register_single_event(21)'><b>Register</b></span>
<span id='blockGen565' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,225,202,0.8);' onclick='getPage("FoxHunt","FoxHunt@Description")'><b>Description</b></span>
<span id='blockGen566' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(238,236,202,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen570' style='background: rgba(243,242,248,0.8);'><img src="static/Icons_Final/Symphony.png" width='250px'/></span><br />
<span id='blockGen571' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(205,212,242,0.8);' onclick='generateTeamRegForm("Symphony")'><b>Register</b></span>
<span id='blockGen572' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(231,201,201,0.8);' onclick='getPage("Symphony","Symphony@Description")'><b>Description</b></span>
<span id='blockGen573' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(215,218,232,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideWaltz'>
<span id='blockGen577' style='background: rgba(248,239,248,0.8);'><img src="static/Icons_Final/Waltz.png" width='250px'/></span><br />
<span id='blockGen578' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(207,237,214,0.8);' onclick='generateTeamRegForm("Waltz")'><b>Register</b></span>
<span id='blockGen579' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(245,203,245,0.8);' onclick='getPage("Waltz","Waltz@Goal")'><b>Goal</b></span>
<span id='blockGen580' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,234,206,0.8);' onclick='getPage("Waltz","Waltz@Specifications")'><b>Specifications</b></span>
<span id='blockGen581' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,228,228,0.8);' onclick='getPage("Waltz","Waltz@Arena")'><b>Arena</b></span>
<span id='blockGen582' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(227,204,219,0.8);' onclick='getPage("Waltz","Waltz@Bot Specification and Rules")'><b>Bot Specification and Rules</b></span>
<span id='blockGen583' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(241,249,237,0.8);' onclick='getPage("Waltz","Waltz@Evaluation")'><b>Evaluation</b></span>
<span id='blockGen584' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(231,225,221,0.8);'><b>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen600' style='background: rgba(230,217,236,0.8);'><img src="static/Icons_Final/lastword.png" width='250px'/></span><br />
<span id='blockGen601' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,203,234,0.8);' onclick='register_single_event(53)'><b>Register</b></span>
<span id='blockGen602' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,241,234,0.8);' onclick='getPage("The_Last_Word","The_Last_Word@Description")'><b>Description</b></span>
<span id='blockGen603' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(241,238,213,0.8);'><b>Contact: Ashwin K S<br/> 9483523498</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideSparsh'>
<span id='blockGen607' style='background: rgba(217,237,239,0.8);'><img src="static/Icons_Final/saprsh.png" width='250px'/></span><br />
<span id='blockGen608' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,219,246,0.8);' onclick='generateTeamRegForm("Sparsh")'><b>Register</b></span>
<span id='blockGen609' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(203,232,230,0.8);' onclick='getPage("Sparsh","Sparsh@Description")'><b>Description</b></span>
<span id='blockGen610' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,202,206,0.8);' onclick='getPage("Sparsh","Sparsh@Introduction")'><b>Introduction</b></span>
<span id='blockGen611' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,212,238,0.8);' onclick='getPage("Sparsh","Sparsh@NeedOfTheHour")'><b>NeedOfTheHour</b></span>
<span id='blockGen612' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,200,204,0.8);' onclick='getPage("Sparsh","Sparsh@problemstatement")'><b>problemstatement</b></span>
<span id='blockGen613' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,231,223,0.8);' onclick='getPage("Sparsh","Sparsh@Rules")'><b>Rules</b></span>
<span id='blockGen614' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(211,232,237,0.8);' onclick='getPage("Sparsh","Sparsh@Faqs")'><b>Faqs</b></span>
<span id='blockGen615' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(239,203,239,0.8);'><b>Contact: Ashwin K S<br/> 9483523498</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen634' style='background: rgba(230,245,239,0.8);'><img src="static/Icons_Final/sky_lantern.png" width='250px'/></span><br />
<span id='blockGen635' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(237,205,201,0.8);' onclick='getPage("Sky_Lanterns","Sky_Lanterns@Description")'><b>Description</b></span>
<span id='blockGen636' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(228,234,229,0.8);'><b>Contact: Ashwin K S<br/> 9483523498</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen640' style='background: rgba(227,213,215,0.8);'><img src="static/Icons_Final/Green_Innovation_Challenge.png" width='250px'/></span><br />
<span id='blockGen641' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(213,224,203,0.8);' onclick='register_single_event(51)'><b>Register</b></span>
<span id='blockGen642' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,237,234,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge@Description")'><b>Description</b></span>
<span id='blockGen643' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(244,236,240,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge@Problem Statement")'><b>Problem Statement</b></span>
<span id='blockGen644' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(223,228,211,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge@Rules and guidelines")'><b>Rules and guidelines</b></span>
<span id='blockGen645' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,248,200,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge@FAQS")'><b>FAQS</b></span>
<span id='blockGen646' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(221,240,228,0.8);'><b>Contact: Amrutash Nanda<br/> 9035057370</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen659' style='background: rgba(243,200,244,0.8);'><img src="static/Icons_Final/Mine_Rush.png" width='250px'/></span><br />
<span id='blockGen660' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(238,208,235,0.8);' onclick='register_single_event(6)'><b>Register</b></span>
<span id='blockGen661' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(222,224,217,0.8);' onclick='getPage("Mine_Rush","Mine_Rush@Description")'><b>Description</b></span>
<span id='blockGen662' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(204,228,235,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen666' style='background: rgba(209,207,223,0.8);'><img src="static/Icons_Final/adverse_mining.png" width='250px'/></span><br />
<span id='blockGen667' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,223,205,0.8);' onclick='register_single_event(2)'><b>Register</b></span>
<span id='blockGen668' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,235,219,0.8);' onclick='getPage("Adverse_Mining_Problem","Adverse_Mining_Problem@Description")'><b>Description</b></span>
<span id='blockGen669' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(204,240,243,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen673' style='background: rgba(220,236,215,0.8);'><img src="static/Icons_Final/Mine_Quest.png" width='250px'/></span><br />
<span id='blockGen674' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(243,219,227,0.8);' onclick='generateTeamRegForm("Mine_Quest")'><b>Register</b></span>
<span id='blockGen675' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,214,232,0.8);' onclick='getPage("Mine_Quest","Mine_Quest@Description")'><b>Description</b></span>
<span id='blockGen676' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(215,228,205,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen680' style='background: rgba(208,233,247,0.8);'><img src="static/Icons_Final/mining_innovation.png" width='250px'/></span><br />
<span id='blockGen681' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(218,220,238,0.8);' onclick='register_single_event(1)'><b>Register</b></span>
<span id='blockGen682' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,237,228,0.8);' onclick='getPage("Innovating_Mining","Innovating_Mining@Description")'><b>Description</b></span>
<span id='blockGen683' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(228,246,203,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen687' style='background: rgba(241,209,228,0.8);'><img src="static/Icons_Final/blast_mine_ventilation.png" width='250px'/></span><br />
<span id='blockGen688' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(220,219,227,0.8);' onclick='register_single_event(5)'><b>Register</b></span>
<span id='blockGen689' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(216,204,232,0.8);' onclick='getPage("Blast_Mine_Ventilation","Blast_Mine_Ventilation@Description")'><b>Description</b></span>
<span id='blockGen690' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(242,217,223,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen694' style='background: rgba(226,206,208,0.8);'><img src="static/Icons_Final/HANGMAN_MAIN.png" width='250px'/></span><br />
<span id='blockGen695' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(235,215,205,0.8);' onclick='register_single_event(4)'><b>Register</b></span>
<span id='blockGen696' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(221,229,205,0.8);' onclick='getPage("Hang-Man","Hang-Man@Description")'><b>Description</b></span>
<span id='blockGen697' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(222,221,218,0.8);'><b>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen701' style='background: rgba(240,246,213,0.8);'><img src="static/Icons_Final/RoboWars.png" width='250px'/></span><br />
<span id='blockGen702' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,215,209,0.8);' onclick='generateTeamRegForm("Robowars")'><b>Register</b></span>
<span id='blockGen703' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,204,200,0.8);' onclick='getPage("Robowars","Robowars@generalrules")'><b>generalrules</b></span>
<span id='blockGen704' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(247,239,236,0.8);' onclick='getPage("Robowars","Robowars@eventformat")'><b>eventformat</b></span>
<span id='blockGen705' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,243,205,0.8);' onclick='getPage("Robowars","Robowars@eventrules")'><b>eventrules</b></span>
<span id='blockGen706' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(229,221,249,0.8);' onclick='getPage("Robowars","Robowars@judging")'><b>judging</b></span>
<span id='blockGen707' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,203,222,0.8);' onclick='getPage("Robowars","Robowars@arenaspecs")'><b>arenaspecs</b></span>
<span id='blockGen708' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(227,230,234,0.8);' onclick='getPage("Robowars","Robowars@mobility")'><b>mobility</b></span>
<span id='blockGen709' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(238,202,221,0.8);' onclick='getPage("Robowars","Robowars@botspecs")'><b>botspecs</b></span>
<span id='blockGen710' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(228,233,215,0.8);' onclick='getPage("Robowars","Robowars@hydraulic")'><b>hydraulic</b></span>
<span id='blockGen711' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(211,230,214,0.8);' onclick='getPage("Robowars","Robowars@power")'><b>power</b></span>
<span id='blockGen712' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,209,215,0.8);' onclick='getPage("Robowars","Robowars@weapon")'><b>weapon</b></span>
<span id='blockGen713' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(243,205,245,0.8);' onclick='getPage("Robowars","Robowars@safety")'><b>safety</b></span>
<span id='blockGen714' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(221,244,216,0.8);' onclick='getPage("Robowars","Robowars@download")'><b>download</b></span>
<span id='blockGen715' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(234,223,221,0.8);'><b>Contact: Akshay K R <br/>koodlyakshay@gmail.com<br/>9731937661</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen752' style='background: rgba(241,220,203,0.8);'><img src="static/Icons_Final/PerfectMachine.png" width='250px'/></span><br />
<span id='blockGen753' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,248,222,0.8);' onclick='generateTeamRegForm("PerfectMachine")'><b>Register</b></span>
<span id='blockGen754' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(202,225,241,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@generalrules")'><b>generalrules</b></span>
<span id='blockGen755' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,214,241,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@eventformat")'><b>eventformat</b></span>
<span id='blockGen756' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(211,230,200,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@judging")'><b>judging</b></span>
<span id='blockGen757' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(239,217,209,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@specifications")'><b>specifications</b></span>
<span id='blockGen758' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(230,227,236,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@mobility")'><b>mobility</b></span>
<span id='blockGen759' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(244,218,240,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@arenaspecs")'><b>arenaspecs</b></span>
<span id='blockGen760' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,229,234,0.8);' onclick='getPage("PerfectMachine","PerfectMachine@download")'><b>download</b></span>
<span id='blockGen761' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(243,202,201,0.8);'><b>Contact: Akshay K R <br/>koodlyakshay@gmail.com<br/>9731937661</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen783' style='background: rgba(235,212,240,0.8);'><img src="static/Icons_Final/WrightFlight.png" width='250px'/></span><br />
<span id='blockGen784' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,230,240,0.8);' onclick='generateTeamRegForm("wrightflight")'><b>Register</b></span>
<span id='blockGen785' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(231,224,236,0.8);' onclick='getPage("wrightflight","wrightflight@generalrules")'><b>generalrules</b></span>
<span id='blockGen786' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,245,246,0.8);' onclick='getPage("wrightflight","wrightflight@eventformat")'><b>eventformat</b></span>
<span id='blockGen787' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(222,230,229,0.8);' onclick='getPage("wrightflight","wrightflight@Glider Specifications")'><b>Glider Specifications</b></span>
<span id='blockGen788' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(248,246,207,0.8);' onclick='getPage("wrightflight","wrightflight@Arena Specifications")'><b>Arena Specifications</b></span>
<span id='blockGen789' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(248,234,229,0.8);' onclick='getPage("wrightflight","wrightflight@Judging Criteria and Scoring")'><b>Judging Criteria and Scoring</b></span>
<span id='blockGen790' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(232,211,220,0.8);'><b>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideProteus'>
<span id='blockGen806' style='background: rgba(223,223,245,0.8);'><img src="static/Icons_Final/Proteus.png" width='250px'/></span><br />
<span id='blockGen807' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(233,222,203,0.8);' onclick='generateTeamRegForm("Proteus")'><b>Register</b></span>
<span id='blockGen808' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(242,223,236,0.8);' onclick='getPage("Proteus","Proteus@General Rules")'><b>General Rules</b></span>
<span id='blockGen809' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(207,247,208,0.8);' onclick='getPage("Proteus","Proteus@Event Rules")'><b>Event Rules</b></span>
<span id='blockGen810' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(231,217,201,0.8);' onclick='getPage("Proteus","Proteus@Bot Specs")'><b>Bot Specs</b></span>
<span id='blockGen811' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(232,223,210,0.8);' onclick='getPage("Proteus","Proteus@Event Format")'><b>Event Format</b></span>
<span id='blockGen812' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(233,208,221,0.8);' onclick='getPage("Proteus","Proteus@Scoring")'><b>Scoring</b></span>
<span id='blockGen813' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(243,237,231,0.8);' onclick='getPage("Proteus","Proteus@download")'><b>download</b></span>
<span id='blockGen814' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(245,202,240,0.8);'><b>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen833' style='background: rgba(213,200,239,0.8);'><img src="static/Icons_Final/Velocity.png" width='250px'/></span><br />
<span id='blockGen834' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(221,204,200,0.8);' onclick='generateTeamRegForm("Velocity")'><b>Register</b></span>
<span id='blockGen835' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,232,236,0.8);' onclick='getPage("Velocity","Velocity@Introduction")'><b>Introduction</b></span>
<span id='blockGen836' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,248,214,0.8);' onclick='getPage("Velocity","Velocity@General Rules")'><b>General Rules</b></span>
<span id='blockGen837' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(218,245,220,0.8);' onclick='getPage("Velocity","Velocity@Event Format")'><b>Event Format</b></span>
<span id='blockGen838' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,238,211,0.8);' onclick='getPage("Velocity","Velocity@Event Rules")'><b>Event Rules</b></span>
<span id='blockGen839' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(238,239,221,0.8);' onclick='getPage("Velocity","Velocity@Arena Specs")'><b>Arena Specs</b></span>
<span id='blockGen840' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(201,204,204,0.8);' onclick='getPage("Velocity","Velocity@Car Specs")'><b>Car Specs</b></span>
<span id='blockGen841' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,232,246,0.8);' onclick='getPage("Velocity","Velocity@Propulsion & Steering")'><b>Propulsion & Steering</b></span>
<span id='blockGen842' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(231,212,242,0.8);'><b>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen864' style='background: rgba(200,229,204,0.8);'><img src="static/Icons_Final/astro_talk.png" width='250px'/></span><br />
<span id='blockGen865' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(227,242,218,0.8);' onclick='register_single_event(49)'><b>Register</b></span>
<span id='blockGen866' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,201,220,0.8);' onclick='getPage("AstroTalk","AstroTalk@Description")'><b>Description</b></span>
<span id='blockGen867' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(229,202,237,0.8);'><b>Contact: Mrinal Phone: 9449030636</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen871' style='background: rgba(200,232,236,0.8);'><img src="static/Icons_Final/starwars.png" width='250px'/></span><br />
<span id='blockGen872' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,205,216,0.8);' onclick='register_single_event(47)'><b>Register</b></span>
<span id='blockGen873' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(226,210,227,0.8);' onclick='getPage("StarWars","StarWars@Description")'><b>Description</b></span>
<span id='blockGen874' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(218,242,240,0.8);'><b>Contact: Mrinal Phone: 9449030636</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen878' style='background: rgba(248,219,244,0.8);'><img src="static/Icons_Final/Beyond_Earth.png" width='250px'/></span><br />
<span id='blockGen879' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,231,245,0.8);' onclick='generateTeamRegForm("BeyondEarth")'><b>Register</b></span>
<span id='blockGen880' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,232,208,0.8);' onclick='getPage("BeyondEarth","BeyondEarth@Description")'><b>Description</b></span>
<span id='blockGen881' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(245,223,244,0.8);'><b>Contact: Mrinal Phone: 9449030636</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen885' style='background: rgba(201,234,221,0.8);'><img src="static/Icons_Final/exhibitions.jpg" width='250px'/></span><br />
<span id='blockGen886' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(224,230,239,0.8);' onclick='register_single_event(48)'><b>Register</b></span>
<span id='blockGen887' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(228,233,238,0.8);' onclick='getPage("Exhibits","Exhibits@Description")'><b>Description</b></span>
<span id='blockGen888' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(246,249,203,0.8);'><b>Contact: Mrinal Phone: 9449030636</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideAoe'>
<span id='blockGen892' style='background: rgba(226,217,204,0.8);'><img src="static/Icons_Final/aoe2.jpg" width='250px'/></span><br />
<span id='blockGen893' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(234,218,204,0.8);' onclick='generateTeamRegForm("Aoe")'><b>Register</b></span>
<span id='blockGen894' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(246,241,234,0.8);' onclick='getPage("Aoe","Aoe@generalrules")'><b>generalrules</b></span>
<span id='blockGen895' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(204,238,200,0.8);' onclick='getPage("Aoe","Aoe@specifications")'><b>specifications</b></span>
<span id='blockGen896' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(206,248,202,0.8);' onclick='getPage("Aoe","Aoe@gamesetting")'><b>gamesetting</b></span>
<span id='blockGen897' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(212,214,209,0.8);'><b>Contact: Satish Chandra <br/> 9740523343</b></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupAoe">
...
<span id='blockGen907' style='background: rgba(210,224,204,0.8);'><img src="static/Icons_Final/COUNTERSTRIKE.png" width='250px'/></span><br />
<span id='blockGen908' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,212,211,0.8);' onclick='generateTeamRegForm("CounterStrike")'><b>Register</b></span>
<span id='blockGen909' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(245,206,233,0.8);' onclick='getPage("CounterStrike","CounterStrike@specifications")'><b>specifications</b></span>
<span id='blockGen910' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(246,221,245,0.8);' onclick='getPage("CounterStrike","CounterStrike@serversettings")'><b>serversettings</b></span>
<span id='blockGen911' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(249,219,203,0.8);' onclick='getPage("CounterStrike","CounterStrike@penalties")'><b>penalties</b></span>
<span id='blockGen912' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(236,203,245,0.8);'><b>Contact: Satish Chandra <br/> 9740523343</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sidedota'>
<span id='blockGen922' style='background: rgba(244,209,236,0.8);'><img src="static/Icons_Final/dOTA.png" width='250px'/></span><br />
<span id='blockGen923' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,209,227,0.8);' onclick='generateTeamRegForm("dota")'><b>Register</b></span>
<span id='blockGen924' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(244,217,206,0.8);' onclick='getPage("dota","dota@specifications")'><b>specifications</b></span>
<span id='blockGen925' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(230,227,206,0.8);' onclick='getPage("dota","dota@Game Setting")'><b>Game Setting</b></span>
<span id='blockGen926' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(208,220,241,0.8);'><b>Contact: Satish Chandra <br/> 9740523343</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideFifa'>
<span id='blockGen933' style='background: rgba(244,205,226,0.8);'><img src="static/Icons_Final/fifa.png" width='250px'/></span><br />
<span id='blockGen934' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(221,242,200,0.8);' onclick='register_single_event(22)'><b>Register</b></span>
<span id='blockGen935' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(212,244,228,0.8);' onclick='getPage("Fifa","Fifa@specifications")'><b>specifications</b></span>
<span id='blockGen936' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(242,244,245,0.8);'><b>Contact: Satish Chandra <br/> 9740523343</b></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideNFS'>
<span id='blockGen940' style='background: rgba(221,235,232,0.8);'><img src="static/Icons_Final/nfs.png" width='250px'/></span><br />
<span id='blockGen941' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(201,243,227,0.8);' onclick='register_single_event(24)'><b>Register</b></span>
<span id='blockGen942' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,204,247,0.8);' onclick='getPage("NFS","NFS@specifications")'><b>specifications</b></span>
<span id='blockGen943' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(201,216,221,0.8);'><b>Contact: Satish Chandra <br/> 9740523343</b></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupNFS">
...
<span id='blockGen947' style='background: rgba(234,247,217,0.8);'><img src="static/Icons_Final/HACKING.png" width='250px'/></span><br />
<span id='blockGen948' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,216,240,0.8);' onclick='register_single_event(63)'><b>Register</b></span>
<span id='blockGen949' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,234,221,0.8);' onclick='getPage("Ethical_Hacking_by_TechDefence","Ethical_Hacking_by_TechDefence@Description")'><b>Description</b></span>
<span id='blockGen950' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,222,242,0.8);' onclick='getPage("Ethical_Hacking_by_TechDefence","Ethical_Hacking_by_TechDefence@Details")'><b>Details</b></span>
<span id='blockGen951' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(229,243,208,0.8);' onclick='getPage("Ethical_Hacking_by_TechDefence","Ethical_Hacking_by_TechDefence@About The Organizer")'><b>About The Organizer</b></span>
<span id='blockGen952' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(210,215,205,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen962' style='background: rgba(219,234,209,0.8);'><img src="static/Icons_Final/Android.png" width='250px'/></span><br />
<span id='blockGen963' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(245,223,227,0.8);' onclick='register_single_event(67)'><b>Register</b></span>
<span id='blockGen964' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(211,211,223,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Workshop Details")'><b>Workshop Details</b></span>
<span id='blockGen965' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(214,242,233,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Description")'><b>Description</b></span>
<span id='blockGen966' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(248,210,234,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Workshop Specialities")'><b>Workshop Specialities</b></span>
<span id='blockGen967' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(244,211,202,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Workshop structure")'><b>Workshop structure</b></span>
<span id='blockGen968' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(203,207,237,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Software")'><b>Software</b></span>
<span id='blockGen969' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(228,230,204,0.8);' onclick='getPage("Android_Application_Development","Android_Application_Development@Other Material")'><b>Other Material</b></span>
<span id='blockGen970' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(239,219,223,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen989' style='background: rgba(203,242,210,0.8);'><img src="static/Icons_Final/3d_photo.jpg" width='250px'/></span><br />
<span id='blockGen990' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(209,231,235,0.8);' onclick='register_single_event(68)'><b>Register</b></span>
<span id='blockGen991' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,219,202,0.8);' onclick='getPage("3D_Photography","3D_Photography@Description")'><b>Description</b></span>
<span id='blockGen992' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(222,229,201,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen996' style='background: rgba(239,210,210,0.8);'><img src="static/Icons_Final/Bridge_design.png" width='250px'/></span><br />
<span id='blockGen997' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,228,208,0.8);' onclick='generateTeamRegForm("Bridge_Design_and_Fabrication")'><b>Register</b></span>
<span id='blockGen998' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(219,212,242,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Description")'><b>Description</b></span>
<span id='blockGen999' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(233,209,238,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Workshop structure")'><b>Workshop structure</b></span>
<span id='blockGen1000' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(213,225,240,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Outcomes")'><b>Outcomes</b></span>
<span id='blockGen1001' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(223,244,244,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Awards")'><b>Awards</b></span>
<span id='blockGen1002' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(220,226,230,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Course Content")'><b>Course Content</b></span>
<span id='blockGen1003' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(223,226,209,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication@Course Details")'><b>Course Details</b></span>
<span id='blockGen1004' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(211,214,240,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1023' style='background: rgba(244,206,220,0.8);'><img src="static/Icons_Final/RC_Aircraft.png" width='250px'/></span><br />
<span id='blockGen1024' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,213,227,0.8);' onclick='generateTeamRegForm("RC_Aircraft_Design_and_Fabrication")'><b>Register</b></span>
<span id='blockGen1025' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(201,225,233,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication@Description")'><b>Description</b></span>
<span id='blockGen1026' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(239,221,245,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication@Workshop Specialties")'><b>Workshop Specialties</b></span>
<span id='blockGen1027' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(217,212,228,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication@Workshop Structure")'><b>Workshop Structure</b></span>
<span id='blockGen1028' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,227,209,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication@Kit Contents")'><b>Kit Contents</b></span>
<span id='blockGen1029' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(221,232,226,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication@Workshop Details")'><b>Workshop Details</b></span>
<span id='blockGen1030' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(200,246,206,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1046' style='background: rgba(243,204,208,0.8);'><img src="static/Icons_Final/AUGMENTED.png" width='250px'/></span><br />
<span id='blockGen1047' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,229,246,0.8);' onclick='generateTeamRegForm("Augmented_Reality")'><b>Register</b></span>
<span id='blockGen1048' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(205,218,221,0.8);' onclick='getPage("Augmented_Reality","Augmented_Reality@Description")'><b>Description</b></span>
<span id='blockGen1049' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(210,237,200,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1053' style='background: rgba(213,246,227,0.8);'><img src="static/Icons_Final/ROBOTICS.png" width='250px'/></span><br />
<span id='blockGen1054' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,232,201,0.8);' onclick='generateTeamRegForm("Humanoid_Robot")'><b>Register</b></span>
<span id='blockGen1055' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(235,215,222,0.8);' onclick='getPage("Humanoid_Robot","Humanoid_Robot@Description")'><b>Description</b></span>
<span id='blockGen1056' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(202,214,211,0.8);'><b>Contact: Hitesh<br/>+91 9916352564<br/><br/>Kratika Gupta<br/>+91 9591113946</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1060' style='background: rgba(227,221,236,0.8);'><img src="static/Icons_Final/SIMPLINEER.png" width='250px'/></span><br />
<span id='blockGen1061' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(225,210,229,0.8);' onclick='getPage("Simplineer","Simplineer@Description")'><b>Description</b></span>
<span id='blockGen1062' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(218,237,226,0.8);' onclick='getPage("Simplineer","Simplineer@Proceedings")'><b>Proceedings</b></span>
<span id='blockGen1063' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(212,216,200,0.8);'><b>Contact: Saurabh Verma (9742091940)<br/>Sumit Bansal (9663358730)</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1070' style='background: rgba(201,213,232,0.8);'><img src="static/Icons_Final/BluePrint.png" width='250px'/></span><br />
<span id='blockGen1071' class="register" style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(234,228,245,0.8);' onclick='register_single_event(35)'><b>Register</b></span>
<span id='blockGen1072' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(240,249,208,0.8);' onclick='getPage("Blue_Print","Blue_Print@Description")'><b>Description</b></span>
<span id='blockGen1073' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(239,247,200,0.8);'><b>Contact: Raghavan<br/>+91-9590390285<br/>raghav10rogers@gmail.com</b></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1077' style='background: rgba(225,217,210,0.8);'><img src="static/Icons_Final/mockstock.png" width='250px'/></span><br />
<span id='blockGen1078' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(210,214,208,0.8);' onclick='getPage("Mockstock","Mockstock@Description")'><b>Description</b></span>
<span id='blockGen1079' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;cursor: pointer;background: rgba(208,228,238,0.8);' onclick='getPage("Mockstock","Mockstock@Details")'><b>Details</b></span>
<span id='blockGen1080' style='width:220px;padding: 3px;padding-left: 15px;padding-right: 15px;background: rgba(243,227,224,0.8);'><b>Contact: Shashank Ajmera<br />08867838479</b></span>
</span>
</td>
<td style='width: 70%'>
