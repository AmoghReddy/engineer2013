...
<span id = "comitteeTronix" style="cursor:pointer;background: rgba(219,204,224,0.8);" onclick="getPage('Tronix')">
<img id="eve1" src="static/Icons_Final/tronix.png"/>
</span>
<span id = "comitteeGaming" style="cursor:pointer;background: rgba(220,226,223,0.8);" onclick="getPage('Gaming')">
<img id="eve2" src="static/Icons_Final/gaming.png"/>
</span>
<span id = "comitteeMining" style="cursor:pointer;background: rgba(209,220,222,0.8);" onclick="getPage('Mining')">
<img id="eve3" src="static/Icons_Final/mining.png"/>
</span>
<span id = "comitteeCivil" style="cursor:pointer;background: rgba(227,245,224,0.8);" onclick="getPage('Civil')">
<img id="eve4" src="static/Icons_Final/civilmain.png"/>
</span>
<span id = "comitteeSce" style="cursor:pointer;background: rgba(221,203,244,0.8);" onclick="getPage('Sce')">
<img id="eve5" src="static/Icons_Final/Sce.png"/>
</span>
<span id = "comitteeMockstock" style="cursor:pointer;background: rgba(238,218,207,0.8);" onclick="getPage('Mockstock')">
<img id="eve6" src="static/Icons_Final/mockstock.png"/>
</span>
<span id = "comitteeMba" style="cursor:pointer;background: rgba(228,250,211,0.8);" onclick="getPage('Mba')">
<img id="eve7" src="static/Icons_Final/MBA.png"/>
</span>
<span id = "comitteeGeneral" style="cursor:pointer;background: rgba(235,222,243,0.8);" onclick="getPage('General')">
<img id="eve8" src="static/Icons_Final/GeneralEvents.png"/>
</span>
<span id = "comitteeChemical" style="cursor:pointer;background: rgba(206,227,246,0.8);" onclick="getPage('Chemical')">
<img id="eve9" src="static/Icons_Final/chemmain.png"/>
</span>
<span id = "comitteeComps" style="cursor:pointer;background: rgba(219,214,246,0.8);" onclick="getPage('Comps')">
<img id="eve10" src="static/Icons_Final/Comps_Main.png"/>
</span>
<span id = "comitteeMaterials" style="cursor:pointer;background: rgba(222,244,233,0.8);" onclick="getPage('Materials')">
<img id="eve11" src="static/Icons_Final/Metamain.png"/>
</span>
<span id = "comitteeBiz" style="cursor:pointer;background: rgba(233,225,204,0.8);" onclick="getPage('Biz')">
<img id="eve12" src="static/Icons_Final/BIZ.png"/>
</span>
<span id = "comitteeBlue_Print" style="cursor:pointer;background: rgba(250,237,203,0.8);" onclick="getPage('Blue_Print')">
<img id="eve13" src="static/Icons_Final/BluePrint.png"/>
</span>
<span id = "comitteeMechanical" style="cursor:pointer;background: rgba(201,215,223,0.8);" onclick="getPage('Mechanical')">
<img id="eve14" src="static/Icons_Final/mech.png"/>
</span>
<span id = "comitteeAstronomy" style="cursor:pointer;background: rgba(203,224,246,0.8);" onclick="getPage('Astronomy')">
...
<table>
<tr>
<td><span id='blockGen7' onclick='getPage("Simplicity")' style='cursor:pointer;width: 250px;background: rgba(244,212,237,0.8);'><img src='static/Icons_Final/SIMPLICITY.png'/></span></td>
<td><span id='blockGen8' onclick='getPage("Waltz")' style='cursor:pointer;width: 250px;background: rgba(222,200,232,0.8);'><img src='static/Icons_Final/Waltz.png'/></span></td>
<td><span id='blockGen9' onclick='getPage("Trade_OFF")' style='cursor:pointer;width: 250px;background: rgba(211,234,219,0.8);'><img src='static/Icons_Final/trade_off.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen10' onclick='getPage("Symphony")' style='cursor:pointer;width: 250px;background: rgba(241,200,209,0.8);'><img src='static/Icons_Final/Symphony.png'/></span></td>
<td><span id='blockGen11' onclick='getPage("TrailBlazer")' style='cursor:pointer;width: 250px;background: rgba(242,238,227,0.8);'><img src='static/Icons_Final/trailblazer.png'/></span></td>
<td><span id='blockGen12' onclick='getPage("Automata")' style='cursor:pointer;width: 250px;background: rgba(205,247,221,0.8);'><img src='static/Icons_Final/AUTOMATA_NEW.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen13' onclick='getPage("FoxHunt")' style='cursor:pointer;width: 250px;background: rgba(227,225,232,0.8);'><img src='static/Icons_Final/foxxhunt.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen20' onclick='getPage("Fifa")' style='cursor:pointer;width: 250px;background: rgba(228,219,204,0.8);'><img src='static/Icons_Final/fifa.png'/></span></td>
<td><span id='blockGen21' onclick='getPage("Aoe")' style='cursor:pointer;width: 250px;background: rgba(240,201,211,0.8);'><img src='static/Icons_Final/aoe3.png'/></span></td>
<td><span id='blockGen22' onclick='getPage("NFS")' style='cursor:pointer;width: 250px;background: rgba(228,209,204,0.8);'><img src='static/Icons_Final/nfs.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen23' onclick='getPage("dota")' style='cursor:pointer;width: 250px;background: rgba(248,201,200,0.8);'><img src='static/Icons_Final/dOTA.png'/></span></td>
<td><span id='blockGen24' onclick='getPage("CounterStrike")' style='cursor:pointer;width: 250px;background: rgba(242,201,221,0.8);'><img src='static/Icons_Final/COUNTERSTRIKE.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen31' onclick='getPage("Innovating_Mining")' style='cursor:pointer;width: 250px;background: rgba(250,213,243,0.8);'><img src='static/Icons_Final/mining_innovation.png'/></span></td>
<td><span id='blockGen32' onclick='getPage("Adverse_Mining_Problem")' style='cursor:pointer;width: 250px;background: rgba(230,222,226,0.8);'><img src='static/Icons_Final/adverse_mining.png'/></span></td>
<td><span id='blockGen33' onclick='getPage("Mine_Quest")' style='cursor:pointer;width: 250px;background: rgba(208,211,204,0.8);'><img src='static/Icons_Final/Mine_Quest.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen34' onclick='getPage("Hang-Man")' style='cursor:pointer;width: 250px;background: rgba(201,248,239,0.8);'><img src='static/Icons_Final/HANGMAN_MAIN.png'/></span></td>
<td><span id='blockGen35' onclick='getPage("Blast_Mine_Ventilation")' style='cursor:pointer;width: 250px;background: rgba(222,234,241,0.8);'><img src='static/Icons_Final/blast_mine_ventilation.png'/></span></td>
<td><span id='blockGen36' onclick='getPage("Mine_Rush")' style='cursor:pointer;width: 250px;background: rgba(210,202,206,0.8);'><img src='static/Icons_Final/Mine_Rush.png'/></span></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen42' onclick='getPage("FantastiCity")' style='cursor:pointer;width: 250px;background: rgba(211,200,223,0.8);'><img src='static/Icons_Final/fantasticity2.png'/></span></td>
<td><span id='blockGen43' onclick='getPage("COLOSSUS")' style='cursor:pointer;width: 250px;background: rgba(233,217,207,0.8);'><img src='static/Icons_Final/Colossus.png'/></span></td>
<td><span id='blockGen44' onclick='getPage("Architect")' style='cursor:pointer;width: 250px;background: rgba(208,205,230,0.8);'><img src='static/Icons_Final/Architect2.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen45' onclick='getPage("Nirvahana")' style='cursor:pointer;width: 250px;background: rgba(240,222,218,0.8);'><img src='static/Icons_Final/Nirvana.png'/></span></td>
<td><span id='blockGen46' onclick='getPage("Mindbend")' style='cursor:pointer;width: 250px;background: rgba(202,222,236,0.8);'><img src='static/Icons_Final/mindbend.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen50' onclick='getPage("Sky_Lanterns")' style='cursor:pointer;width: 250px;background: rgba(211,233,249,0.8);'><img src='static/Icons_Final/sky_lantern.png'/></span></td>
<td><span id='blockGen51' onclick='getPage("Green_Inovation_Challenge")' style='cursor:pointer;width: 250px;background: rgba(246,249,207,0.8);'><img src='static/Icons_Final/Green_Product_Design.png'/></span></td>
<td><span id='blockGen52' onclick='getPage("Sparsh")' style='cursor:pointer;width: 250px;background: rgba(222,218,204,0.8);'><img src='static/Icons_Final/saprsh.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen53' onclick='getPage("The_Last_Word")' style='cursor:pointer;width: 250px;background: rgba(239,213,249,0.8);'><img src='static/Icons_Final/lastword.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen63' onclick='getPage("Ethical_Hacking_by_TechDefence")' style='cursor:pointer;width: 250px;background: rgba(219,240,234,0.8);'><img src='static/Icons_Final/HACKING.png'/></span></td>
<td><span id='blockGen64' onclick='getPage("Augmented_Reality")' style='cursor:pointer;width: 250px;background: rgba(205,227,213,0.8);'><img src='static/Icons_Final/AUGMENTED.png'/></span></td>
<td><button id='blockGen65' class='button1' onclick='getPage("3D_Photography")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(209,218,250,0.8);'><h1 style='text-align:center;font-family: acens;'>3D Photography</h1></td>
</tr>
<tr>
<td><span id='blockGen66' onclick='getPage("RC_Aircraft_Design_and_Fabrication")' style='cursor:pointer;width: 250px;background: rgba(234,223,245,0.8);'><img src='static/Icons_Final/RC_Aircraft.png'/></span></td>
<td><span id='blockGen67' onclick='getPage("Humanoid_Robot")' style='cursor:pointer;width: 250px;background: rgba(204,241,248,0.8);'><img src='static/Icons_Final/ROBOTICS.png'/></span></td>
<td><span id='blockGen68' onclick='getPage("Android Application Development")' style='cursor:pointer;width: 250px;background: rgba(204,236,211,0.8);'><img src='static/Icons_Final/Android.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen69' onclick='getPage("Bridge_Design_and_Fabrication")' style='cursor:pointer;width: 250px;background: rgba(244,222,205,0.8);'><img src='static/Icons_Final/Bridge_design.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen73' onclick='getPage("MindBend")' style='cursor:pointer;width: 250px;background: rgba(231,250,231,0.8);'><img src='static/Icons_Final/mindbend.png'/></span></td>
<td><span id='blockGen74' onclick='getPage("HR_Event")' style='cursor:pointer;width: 250px;background: rgba(201,203,207,0.8);'><img src='static/Icons_Final/HR.png'/></span></td>
<td><span id='blockGen75' onclick='getPage("Markenza")' style='cursor:pointer;width: 250px;background: rgba(236,202,224,0.8);'><img src='static/Icons_Final/MARKENZA.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen76' onclick='getPage("Finance_Event")' style='cursor:pointer;width: 250px;background: rgba(246,203,218,0.8);'><img src='static/Icons_Final/Finance.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen84' onclick='getPage("Simplineer")' style='cursor:pointer;width: 250px;background: rgba(202,225,206,0.8);'><img src='static/Icons_Final/SIMPLINEER.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen93' onclick='getPage("Industry_Defined_Problem")' style='cursor:pointer;width: 250px;background: rgba(233,204,202,0.8);'><img src='static/Icons_Final/IDP.png'/></span></td>
<td><button id='blockGen94' class='button1' onclick='getPage("Contraption")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(209,248,205,0.8);'><h1 style='text-align:center;font-family: acens;'>Contraption</h1></td>
<td><span id='blockGen95' onclick='getPage("The_Portal")' style='cursor:pointer;width: 250px;background: rgba(243,210,210,0.8);'><img src='static/Icons_Final/the_portal.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen96' onclick='getPage("Chemical_Breakdown")' style='cursor:pointer;width: 250px;background: rgba(213,213,237,0.8);'><img src='static/Icons_Final/Chemical_Breakdown.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen102' onclick='getPage("Inscription")' style='cursor:pointer;width: 250px;background: rgba(236,235,213,0.8);'><img src='static/Icons_Final/INSCRIPTION.png'/></span></td>
<td><span id='blockGen103' onclick='getPage("ECTF_-_Capture_the_Flag")' style='cursor:pointer;width: 250px;background: rgba(246,207,208,0.8);'><img src='static/Icons_Final/ECTF.png'/></span></td>
<td><span id='blockGen104' onclick='getPage("Virtual_Bounty")' style='cursor:pointer;width: 250px;background: rgba(227,206,237,0.8);'><img src='static/Icons_Final/VIRTUAL_BOUNTY2.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen105' onclick='getPage("Kode_Kombat")' style='cursor:pointer;width: 250px;background: rgba(250,231,211,0.8);'><img src='static/Icons_Final/CODE_KOMBAT.png'/></span></td>
<td><span id='blockGen106' onclick='getPage("Marathon")' style='cursor:pointer;width: 250px;background: rgba(202,243,250,0.8);'><img src='static/Icons_Final/marathon_final.png'/></span></td>
<td><span id='blockGen107' onclick='getPage("Rectify")' style='cursor:pointer;width: 250px;background: rgba(217,215,203,0.8);'><img src='static/Icons_Final/RECTIFY.png'/></span></td>
</tr>
</table>
</span>
</td>
...
<table>
<tr>
<td><span id='blockGen117' onclick='getPage("mindBend")' style='cursor:pointer;width: 250px;background: rgba(211,221,215,0.8);'><img src='static/Icons_Final/mindbend.png'/></span></td>
<td><span id='blockGen118' onclick='getPage("SEM_and_TEM_Expo")' style='cursor:pointer;width: 250px;background: rgba(200,206,231,0.8);'><img src='static/Icons_Final/SEMTEMExpo.png'/></span></td>
<td><span id='blockGen119' onclick='getPage("MetaMagic")' style='cursor:pointer;width: 250px;background: rgba(239,244,221,0.8);'><img src='static/Icons_Final/MetaMagic.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen120' onclick='getPage("SEM_Photography_Contest")' style='cursor:pointer;width: 250px;background: rgba(228,208,219,0.8);'><img src='static/Icons_Final/SEMphotography.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen124' onclick='getPage("Product_Design_Challenge")' style='cursor:pointer;width: 250px;background: rgba(244,229,223,0.8);'><img src='static/Icons_Final/PRODUCT_DESIGN_123.png'/></span></td>
<td><span id='blockGen125' onclick='getPage("Campus_Social_Innovision_Challenge")' style='cursor:pointer;width: 250px;background: rgba(246,249,228,0.8);'><img src='static/Icons_Final/campussocialinnovation.png'/></span></td>
<td><span id='blockGen126' onclick='getPage("Case_Study_challenge")' style='cursor:pointer;width: 250px;background: rgba(230,236,243,0.8);'><img src='static/Icons_Final/casestudychallenge.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen127' onclick='getPage("Data_Analysis_Challange")' style='cursor:pointer;width: 250px;background: rgba(203,208,230,0.8);'><img src='static/Icons_Final/data_analysischallenge.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen138' onclick='getPage("Velocity")' style='cursor:pointer;width: 250px;background: rgba(235,246,240,0.8);'><img src='static/Icons_Final/Velocity.png'/></span></td>
<td><span id='blockGen139' onclick='getPage("Proteus")' style='cursor:pointer;width: 250px;background: rgba(215,212,223,0.8);'><img src='static/Icons_Final/Proteus.png'/></span></td>
<td><span id='blockGen140' onclick='getPage("PerfectMachine")' style='cursor:pointer;width: 250px;background: rgba(227,203,203,0.8);'><img src='static/Icons_Final/PerfectMachine.png'/></span></td>
</tr>
<tr>
<td><span id='blockGen141' onclick='getPage("Robowars")' style='cursor:pointer;width: 250px;background: rgba(228,240,230,0.8);'><img src='static/Icons_Final/RoboWars.png'/></span></td>
<td><span id='blockGen142' onclick='getPage("wrightflight")' style='cursor:pointer;width: 250px;background: rgba(232,248,218,0.8);'><img src='static/Icons_Final/WrightFlight.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen152' onclick='getPage("BeyondEarth")' style='cursor:pointer;width: 250px;background: rgba(213,219,222,0.8);'><img src='static/Icons_Final/Beyond_Earth.png'/></span></td>
<td><span id='blockGen153' onclick='getPage("StarWars")' style='cursor:pointer;width: 250px;background: rgba(215,239,209,0.8);'><img src='static/Icons_Final/starwars.png'/></span></td>
<td><button id='blockGen154' class='button1' onclick='getPage("Exhibits")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(212,243,248,0.8);'><h1 style='text-align:center;font-family: acens;'>Exhibits</h1></td>
</tr>
<tr>
<td><span id='blockGen155' onclick='getPage("AstroTalk")' style='cursor:pointer;width: 250px;background: rgba(240,224,208,0.8);'><img src='static/Icons_Final/astro_talk.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<table>
<tr>
<td><span id='blockGen165' onclick='getPage("Psychedelic_Room")' style='cursor:pointer;width: 250px;background: rgba(213,209,239,0.8);'><img src='static/Icons_Final/PsychRoom.png'/></span></td>
<td><button id='blockGen166' class='button1' onclick='getPage("Dance_Dance_Revolution")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(217,227,225,0.8);'><h1 style='text-align:center;font-family: acens;'>Dance Dance Revolution</h1></td>
<td><button id='blockGen167' class='button1' onclick='getPage("Arcade_Room")' style='cursor:pointer;border-radius: 0%;width: 250px;height: 250px;margin-top: 0px;background: rgba(227,242,227,0.8);'><h1 style='text-align:center;font-family: acens;'>Arcade Room</h1></td>
</tr>
<tr>
<td><span id='blockGen168' onclick='getPage("Blitzkrieg")' style='cursor:pointer;width: 250px;background: rgba(250,230,210,0.8);'><img src='static/Icons_Final/blitzkrieg.png'/></span></td>
<td><span id='blockGen169' onclick='getPage("Megapixel")' style='cursor:pointer;width: 250px;background: rgba(200,218,232,0.8);'><img src='static/Icons_Final/megapixel.png'/></span></td>
</table>
</span>
</td>
</tr>
...
<span id='blockGen170' style='background: rgba(225,247,220,0.8);'><img src="static/Icons_Final/SIMPLICITY.png" width='250px'/></span><br />
<span id='blockGen171' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,227,241,0.8);' onclick='register_single_event(15)'><h3>Register</h3></span>
<span id='blockGen172' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(209,246,234,0.8);' onclick='getPage("Simplicity","Simplicity_Description")'><h3>Description</h3></span>
<span id='blockGen173' style='width:220px;padding: 15px;border-radius:20px;background: rgba(241,219,229,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideWaltz'>
<span id='blockGen178' style='background: rgba(205,218,232,0.8);'><img src="static/Icons_Final/Waltz.png" width='250px'/></span><br />
<span id='blockGen179' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,239,216,0.8);' onclick='register_single_event(16)'><h3>Register</h3></span>
<span id='blockGen180' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,249,241,0.8);' onclick='getPage("Waltz","Waltz_Arena")'><h3>Arena</h3></span>
<span id='blockGen181' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,220,201,0.8);' onclick='getPage("Waltz","Waltz_Goal")'><h3>Goal</h3></span>
<span id='blockGen182' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(243,236,236,0.8);' onclick='getPage("Waltz","Waltz_Specifications")'><h3>Specifications</h3></span>
<span id='blockGen183' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,209,216,0.8);' onclick='getPage("Waltz","Waltz_Evaluation")'><h3>Evaluation</h3></span>
<span id='blockGen184' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,228,226,0.8);' onclick='getPage("Waltz","Waltz_Bot Specification and Rules")'><h3>Bot Specification and Rules</h3></span>
<span id='blockGen185' style='width:220px;padding: 15px;border-radius:20px;background: rgba(204,225,201,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen202' style='background: rgba(247,207,237,0.8);'><img src="static/Icons_Final/trade_off.png" width='250px'/></span><br />
<span id='blockGen203' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,239,215,0.8);' onclick='register_single_event(17)'><h3>Register</h3></span>
<span id='blockGen204' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(246,215,245,0.8);' onclick='getPage("Trade_OFF","Trade_OFF_Description")'><h3>Description</h3></span>
<span id='blockGen205' style='width:220px;padding: 15px;border-radius:20px;background: rgba(227,230,231,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen210' style='background: rgba(205,200,205,0.8);'><img src="static/Icons_Final/Symphony.png" width='250px'/></span><br />
<span id='blockGen211' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,207,243,0.8);' onclick='register_single_event(18)'><h3>Register</h3></span>
<span id='blockGen212' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(243,230,245,0.8);' onclick='getPage("Symphony","Symphony_Description")'><h3>Description</h3></span>
<span id='blockGen213' style='width:220px;padding: 15px;border-radius:20px;background: rgba(246,247,230,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen218' style='background: rgba(222,217,238,0.8);'><img src="static/Icons_Final/trailblazer.png" width='250px'/></span><br />
<span id='blockGen219' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(241,233,218,0.8);' onclick='register_single_event(19)'><h3>Register</h3></span>
<span id='blockGen220' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,237,240,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_Arena")'><h3>Arena</h3></span>
<span id='blockGen221' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,220,212,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_Description")'><h3>Description</h3></span>
<span id='blockGen222' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(203,240,219,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_ContestProcedure")'><h3>ContestProcedure</h3></span>
<span id='blockGen223' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,237,233,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_samplearena")'><h3>samplearena</h3></span>
<span id='blockGen224' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,213,207,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_OtherDetails")'><h3>OtherDetails</h3></span>
<span id='blockGen225' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,227,241,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_botspecs")'><h3>botspecs</h3></span>
<span id='blockGen226' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,205,234,0.8);' onclick='getPage("TrailBlazer","TrailBlazer_goal")'><h3>goal</h3></span>
<span id='blockGen227' style='width:220px;padding: 15px;border-radius:20px;background: rgba(249,240,240,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/> nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen250' style='background: rgba(231,206,220,0.8);'><img src="static/Icons_Final/AUTOMATA_NEW.png" width='250px'/></span><br />
<span id='blockGen251' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(241,232,236,0.8);' onclick='register_single_event(20)'><h3>Register</h3></span>
<span id='blockGen252' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(212,250,244,0.8);' onclick='getPage("Automata","Automata_download")'><h3>download</h3></span>
<span id='blockGen253' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,240,247,0.8);' onclick='getPage("Automata","Automata_Description")'><h3>Description</h3></span>
<span id='blockGen254' style='width:220px;padding: 15px;border-radius:20px;background: rgba(235,244,245,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/> nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideFoxHunt'>
<span id='blockGen262' style='background: rgba(226,238,239,0.8);'><img src="static/Icons_Final/foxxhunt.png" width='250px'/></span><br />
<span id='blockGen263' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(200,225,200,0.8);' onclick='register_single_event(21)'><h3>Register</h3></span>
<span id='blockGen264' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,245,200,0.8);' onclick='getPage("FoxHunt","FoxHunt_Description")'><h3>Description</h3></span>
<span id='blockGen265' style='width:220px;padding: 15px;border-radius:20px;background: rgba(224,236,207,0.8);'><h3>Contact: Nanda Kumar(9945248355) <br/>nanda9045@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideFifa'>
<span id='blockGen270' style='background: rgba(237,234,215,0.8);'><img src="static/Icons_Final/fifa.png" width='250px'/></span><br />
<span id='blockGen271' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,223,229,0.8);' onclick='register_single_event(22)'><h3>Register</h3></span>
<span id='blockGen272' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,242,209,0.8);' onclick='getPage("Fifa","Fifa_specifications")'><h3>specifications</h3></span>
<span id='blockGen273' style='width:220px;padding: 15px;border-radius:20px;background: rgba(241,239,222,0.8);'><h3>Contact: Satish Chandra <br/> 9740523343</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideAoe'>
<span id='blockGen278' style='background: rgba(245,201,237,0.8);'><img src="static/Icons_Final/aoe3.png" width='250px'/></span><br />
<span id='blockGen279' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,229,211,0.8);' onclick='register_single_event(23)'><h3>Register</h3></span>
<span id='blockGen280' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,239,243,0.8);' onclick='getPage("Aoe","Aoe_specifications")'><h3>specifications</h3></span>
<span id='blockGen281' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,247,240,0.8);' onclick='getPage("Aoe","Aoe_generalrules")'><h3>generalrules</h3></span>
<span id='blockGen282' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,235,229,0.8);' onclick='getPage("Aoe","Aoe_gamesetting")'><h3>gamesetting</h3></span>
<span id='blockGen283' style='width:220px;padding: 15px;border-radius:20px;background: rgba(240,222,237,0.8);'><h3>Contact: Satish Chandra <br/> 9740523343</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupAoe">
...
<td valign='top' style='width: 30%'>
<span id='sideNFS'>
<span id='blockGen294' style='background: rgba(243,202,250,0.8);'><img src="static/Icons_Final/nfs.png" width='250px'/></span><br />
<span id='blockGen295' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,208,221,0.8);' onclick='register_single_event(24)'><h3>Register</h3></span>
<span id='blockGen296' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,229,214,0.8);' onclick='getPage("NFS","NFS_specifications")'><h3>specifications</h3></span>
<span id='blockGen297' style='width:220px;padding: 15px;border-radius:20px;background: rgba(228,229,244,0.8);'><h3>Contact: Satish Chandra <br/> 9740523343</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupNFS">
...
<td valign='top' style='width: 30%'>
<span id='sidedota'>
<span id='blockGen302' style='background: rgba(249,217,244,0.8);'><img src="static/Icons_Final/dOTA.png" width='250px'/></span><br />
<span id='blockGen303' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,221,221,0.8);' onclick='register_single_event(25)'><h3>Register</h3></span>
<span id='blockGen304' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,220,221,0.8);' onclick='getPage("dota","dota_specifications")'><h3>specifications</h3></span>
<span id='blockGen305' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,207,224,0.8);' onclick='getPage("dota","dota_gamesetting")'><h3>gamesetting</h3></span>
<span id='blockGen306' style='width:220px;padding: 15px;border-radius:20px;background: rgba(205,232,235,0.8);'><h3>Contact: Satish Chandra <br/> 9740523343</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen314' style='background: rgba(244,215,235,0.8);'><img src="static/Icons_Final/COUNTERSTRIKE.png" width='250px'/></span><br />
<span id='blockGen315' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,234,228,0.8);' onclick='register_single_event(26)'><h3>Register</h3></span>
<span id='blockGen316' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,242,229,0.8);' onclick='getPage("CounterStrike","CounterStrike_specifications")'><h3>specifications</h3></span>
<span id='blockGen317' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(200,244,217,0.8);' onclick='getPage("CounterStrike","CounterStrike_serversettings")'><h3>serversettings</h3></span>
<span id='blockGen318' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(217,227,249,0.8);' onclick='getPage("CounterStrike","CounterStrike_penalties")'><h3>penalties</h3></span>
<span id='blockGen319' style='width:220px;padding: 15px;border-radius:20px;background: rgba(208,245,219,0.8);'><h3>Contact: Satish Chandra <br/> 9740523343</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen330' style='background: rgba(238,233,227,0.8);'><img src="static/Icons_Final/mining_innovation.png" width='250px'/></span><br />
<span id='blockGen331' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,216,203,0.8);' onclick='register_single_event(1)'><h3>Register</h3></span>
<span id='blockGen332' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,235,216,0.8);' onclick='getPage("Innovating_Mining","Innovating_Mining_Description")'><h3>Description</h3></span>
<span id='blockGen333' style='width:220px;padding: 15px;border-radius:20px;background: rgba(236,225,208,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen338' style='background: rgba(235,204,204,0.8);'><img src="static/Icons_Final/adverse_mining.png" width='250px'/></span><br />
<span id='blockGen339' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(239,232,228,0.8);' onclick='register_single_event(2)'><h3>Register</h3></span>
<span id='blockGen340' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,207,233,0.8);' onclick='getPage("Adverse_Mining_Problem","Adverse_Mining_Problem_Description")'><h3>Description</h3></span>
<span id='blockGen341' style='width:220px;padding: 15px;border-radius:20px;background: rgba(234,237,239,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen346' style='background: rgba(227,224,230,0.8);'><img src="static/Icons_Final/Mine_Quest.png" width='250px'/></span><br />
<span id='blockGen347' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,220,249,0.8);' onclick='register_single_event(3)'><h3>Register</h3></span>
<span id='blockGen348' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(217,220,240,0.8);' onclick='getPage("Mine_Quest","Mine_Quest_Description")'><h3>Description</h3></span>
<span id='blockGen349' style='width:220px;padding: 15px;border-radius:20px;background: rgba(250,240,230,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen354' style='background: rgba(214,205,250,0.8);'><img src="static/Icons_Final/HANGMAN_MAIN.png" width='250px'/></span><br />
<span id='blockGen355' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(218,227,203,0.8);' onclick='register_single_event(4)'><h3>Register</h3></span>
<span id='blockGen356' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,237,210,0.8);' onclick='getPage("Hang-Man","Hang-Man_Description")'><h3>Description</h3></span>
<span id='blockGen357' style='width:220px;padding: 15px;border-radius:20px;background: rgba(202,234,217,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen362' style='background: rgba(217,207,211,0.8);'><img src="static/Icons_Final/blast_mine_ventilation.png" width='250px'/></span><br />
<span id='blockGen363' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,211,211,0.8);' onclick='register_single_event(5)'><h3>Register</h3></span>
<span id='blockGen364' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(233,208,241,0.8);' onclick='getPage("Blast_Mine_Ventilation","Blast_Mine_Ventilation_Description")'><h3>Description</h3></span>
<span id='blockGen365' style='width:220px;padding: 15px;border-radius:20px;background: rgba(207,224,202,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen370' style='background: rgba(234,248,204,0.8);'><img src="static/Icons_Final/Mine_Rush.png" width='250px'/></span><br />
<span id='blockGen371' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(242,239,232,0.8);' onclick='register_single_event(6)'><h3>Register</h3></span>
<span id='blockGen372' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,234,201,0.8);' onclick='getPage("Mine_Rush","Mine_Rush_Description")'><h3>Description</h3></span>
<span id='blockGen373' style='width:220px;padding: 15px;border-radius:20px;background: rgba(202,247,242,0.8);'><h3>Contact: Arjun Thumbayil(8105941509) - arjunthumbayil@hotmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen378' style='background: rgba(228,228,212,0.8);'><img src="static/Icons_Final/Techspeak.png" width='250px'/></span><br />
<span id='blockGen379' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,234,205,0.8);' onclick='getPage("Tech_Speak","Tech_Speak_Description")'><h3>Description</h3></span>
<span id='blockGen380' style='width:220px;padding: 15px;border-radius:20px;background: rgba(203,208,204,0.8);'><h3>Contact: Aashish Mane - +91 9945049097</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen384' style='background: rgba(231,225,202,0.8);'><img src="static/Icons_Final/fantasticity2.png" width='250px'/></span><br />
<span id='blockGen385' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,202,208,0.8);' onclick='register_single_event(41)'><h3>Register</h3></span>
<span id='blockGen386' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,227,212,0.8);' onclick='getPage("FantastiCity","FantastiCity_Description")'><h3>Description</h3></span>
<span id='blockGen387' style='width:220px;padding: 15px;border-radius:20px;background: rgba(236,216,236,0.8);'><h3>Contact: B.THEJA<br/>+919480435585<br/>bnmtheja@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen392' style='background: rgba(231,249,235,0.8);'><img src="static/Icons_Final/Colossus.png" width='250px'/></span><br />
<span id='blockGen393' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(241,215,211,0.8);' onclick='register_single_event(42)'><h3>Register</h3></span>
<span id='blockGen394' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,247,222,0.8);' onclick='getPage("COLOSSUS","COLOSSUS_Description")'><h3>Description</h3></span>
<span id='blockGen395' style='width:220px;padding: 15px;border-radius:20px;background: rgba(213,227,219,0.8);'><h3>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen400' style='background: rgba(204,226,212,0.8);'><img src="static/Icons_Final/Architect2.png" width='250px'/></span><br />
<span id='blockGen401' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,206,201,0.8);' onclick='register_single_event(43)'><h3>Register</h3></span>
<span id='blockGen402' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(246,220,214,0.8);' onclick='getPage("Architect","Architect_Description")'><h3>Description</h3></span>
<span id='blockGen403' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,218,245,0.8);' onclick='getPage("Architect","Architect_format")'><h3>format</h3></span>
<span id='blockGen404' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(216,239,218,0.8);' onclick='getPage("Architect","Architect_Eligibility")'><h3>Eligibility</h3></span>
<span id='blockGen405' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,231,216,0.8);' onclick='getPage("Architect","Architect_Home")'><h3>Home</h3></span>
<span id='blockGen406' style='width:220px;padding: 15px;border-radius:20px;background: rgba(212,228,250,0.8);'><h3>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Sushil Kumar<br/>+918867345233<br/>sushil199124@gmail.com<br/></h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen420' style='background: rgba(247,212,224,0.8);'><img src="static/Icons_Final/Nirvana.png" width='250px'/></span><br />
<span id='blockGen421' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,228,212,0.8);' onclick='register_single_event(44)'><h3>Register</h3></span>
<span id='blockGen422' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,219,207,0.8);' onclick='getPage("Nirvahana","Nirvahana_Home")'><h3>Home</h3></span>
<span id='blockGen423' style='width:220px;padding: 15px;border-radius:20px;background: rgba(224,210,203,0.8);'><h3>Contact: Mohan Krishna.T<br/>+917411918682<br/>krishnamohan651@gmail.com<br/>Niveditha.J<br/>+917795543699<br/>niveditha811@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen428' style='background: rgba(249,243,201,0.8);'><img src="static/Icons_Final/mindbend.png" width='250px'/></span><br />
<span id='blockGen429' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,240,202,0.8);' onclick='register_single_event(62)'><h3>Register</h3></span>
<span id='blockGen430' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,201,225,0.8);' onclick='getPage("Mindbend","Mindbend_eligibility")'><h3>eligibility</h3></span>
<span id='blockGen431' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,234,217,0.8);' onclick='getPage("Mindbend","Mindbend_Description")'><h3>Description</h3></span>
<span id='blockGen432' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,217,203,0.8);' onclick='getPage("Mindbend","Mindbend_format")'><h3>format</h3></span>
<span id='blockGen433' style='width:220px;padding: 15px;border-radius:20px;background: rgba(227,241,208,0.8);'><h3>Contact: B. THEJA <br/>+919480435585 <br/>bnmtheja@gmail.com <br/>Padmini M <br/>+918123463865 <br/>pm27178@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen444' style='background: rgba(220,206,238,0.8);'><img src="static/Icons_Final/sky_lantern.png" width='250px'/></span><br />
<span id='blockGen445' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,243,213,0.8);' onclick='register_single_event(50)'><h3>Register</h3></span>
<span id='blockGen446' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(205,210,248,0.8);' onclick='getPage("Sky_Lanterns","Sky_Lanterns_Description")'><h3>Description</h3></span>
<span id='blockGen447' style='width:220px;padding: 15px;border-radius:20px;background: rgba(241,207,211,0.8);'><h3>Contact: Ashwin K S<br/> 9483523498</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen452' style='background: rgba(218,233,240,0.8);'><img src="static/Icons_Final/Green_Product_Design.png" width='250px'/></span><br />
<span id='blockGen453' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,225,207,0.8);' onclick='register_single_event(51)'><h3>Register</h3></span>
<span id='blockGen454' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,248,227,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge_Description")'><h3>Description</h3></span>
<span id='blockGen455' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,249,216,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge_FAQS")'><h3>FAQS</h3></span>
<span id='blockGen456' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,217,223,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge_Problem Statement")'><h3>Problem Statement</h3></span>
<span id='blockGen457' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,204,219,0.8);' onclick='getPage("Green_Inovation_Challenge","Green_Inovation_Challenge_Rules and guidelines")'><h3>Rules and guidelines</h3></span>
<span id='blockGen458' style='width:220px;padding: 15px;border-radius:20px;background: rgba(224,245,213,0.8);'><h3>Contact: Ashwin K S<br/> 9483523498</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Q. What is the maximum size of a team? <br />A. The team can comprise of a maximum of 4 members.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Can the participating team comprise of only 1 member?<br />A. Yes<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Can teams be formed by mixing students of different disciplines/departments?<br />A. Yes<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Can teams be formed by mixing undergraduate and post-graduate engineering students?<br />A. No. This contest is only open for undergraduate engineering students.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Can one team submit more than one entry?<br />A. Yes, one team can send more than one entry.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Whom do we contact in case of any queries?<br />A. In case of any queries, send a mail sce@engineer.org.in or refer to the Contact Us List which appears on every page.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Can entries be submitted in other languages?<br />A. No, entries are to be submitted only in English<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Should my presentation necessarily be a solution?<br />A. No, Your presentation can be a product proposal, changes in an existing product, a concept with a feasibility aspect, or a solution.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. Would a prototype be required if I'm a short listed candidate?<br />A. Not necessary, but bonus points will be awarded based on level of implementation of idea which could be shown through a physical prototype or a recorded video.<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Q. How will I know whether my entry has been short-listed or not?<br />A. We will inform you through mail<br /></span><span id="blockGen462" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The organisers retain the right to make any changes to the event, format, dates, rules and in anymatter related to this event at any time before or during the event.
</span>
</span>
...
<td valign='top' style='width: 30%'>
<span id='sideSparsh'>
<span id='blockGen471' style='background: rgba(236,217,214,0.8);'><img src="static/Icons_Final/saprsh.png" width='250px'/></span><br />
<span id='blockGen472' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(225,204,246,0.8);' onclick='register_single_event(52)'><h3>Register</h3></span>
<span id='blockGen473' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(200,222,207,0.8);' onclick='getPage("Sparsh","Sparsh_Rules")'><h3>Rules</h3></span>
<span id='blockGen474' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(209,242,208,0.8);' onclick='getPage("Sparsh","Sparsh_problemstatement")'><h3>problemstatement</h3></span>
<span id='blockGen475' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,246,234,0.8);' onclick='getPage("Sparsh","Sparsh_Description")'><h3>Description</h3></span>
<span id='blockGen476' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,211,212,0.8);' onclick='getPage("Sparsh","Sparsh_Introduction")'><h3>Introduction</h3></span>
<span id='blockGen477' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,229,220,0.8);' onclick='getPage("Sparsh","Sparsh_NeedOfTheHour")'><h3>NeedOfTheHour</h3></span>
<span id='blockGen478' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(232,243,243,0.8);' onclick='getPage("Sparsh","Sparsh_Faqs")'><h3>Faqs</h3></span>
<span id='blockGen479' style='width:220px;padding: 15px;border-radius:20px;background: rgba(200,231,238,0.8);'><h3>Contact: Ashwin K S<br/> 9483523498</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen499' style='background: rgba(229,205,243,0.8);'><img src="static/Icons_Final/lastword.png" width='250px'/></span><br />
<span id='blockGen500' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(221,249,228,0.8);' onclick='register_single_event(53)'><h3>Register</h3></span>
<span id='blockGen501' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(221,244,243,0.8);' onclick='getPage("The_Last_Word","The_Last_Word_Description")'><h3>Description</h3></span>
<span id='blockGen502' style='width:220px;padding: 15px;border-radius:20px;background: rgba(203,207,240,0.8);'><h3>Contact: Ashwin K S<br/> 9483523498</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen507' style='background: rgba(214,210,248,0.8);'><img src="static/Icons_Final/mockstock.png" width='250px'/></span><br />
<span id='blockGen508' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,237,205,0.8);' onclick='getPage("Mockstock","Mockstock_Description")'><h3>Description</h3></span>
<span id='blockGen509' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,204,202,0.8);' onclick='getPage("Mockstock","Mockstock_Details")'><h3>Details</h3></span>
<span id='blockGen510' style='width:220px;padding: 15px;border-radius:20px;background: rgba(248,220,241,0.8);'><h3>Contact: Shashank Ajmera<br />08867838479</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id="blockGen516" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 The event starts on 21st of October, and goes on till 25th of October. (The main event has been postponed due to technical difficulties).However, the trial versions will be put up soon (before 21st) for the users to get used to the environment.</span><span id="blockGen515" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The event will start on evenings, at 7:00 pm, and go on till 1:00 am, exactly like the American market, for all four days. </span><span id="blockGen515" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The trading will be inter-day, i.e., whatever your portfolio is at the end of the day, the same will be carried on to the next day. Hence, the final winner will be the one who makes the maximum cumulative profit after four days. </span><span id="blockGen515" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Prizes:</b><br /> Winner gets an amount of Rs. 5000/-</span><span id="blockGen515" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
</span>
</td>
...
<span id='blockGen517' style='background: rgba(205,235,204,0.8);'><img src="static/Icons_Final/HACKING.png" width='250px'/></span><br />
<span id='blockGen518' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(207,228,215,0.8);' onclick='register_single_event(63)'><h3>Register</h3></span>
<span id='blockGen519' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(217,223,238,0.8);' onclick='getPage("Ethical_Hacking_by_TechDefence","Ethical_Hacking_by_TechDefence_Description")'><h3>Description</h3></span>
<span id='blockGen520' style='width:220px;padding: 15px;border-radius:20px;background: rgba(236,236,226,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
INTRODUCTION </span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >As information security increasingly becoming a boardroom level concern, training and certification are becoming increasingly important for candidates and companies. With a promising novel initiative on the cards, this year TechDefence and ENGINEER '13 has decided to extend the prospectus of Hack Track- Award Winning Hands on Workshop on Ethical Hacking and Information Security in association with Sunny Vaghela, Director & CTO of TechDefenceacross India.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Level 1</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Wireless and Web application Hacking & Security</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Android Hacking and security</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Google & email hacking</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Cyber forensics</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Investigation Methodologies & Cyber Forensics</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Reverse Engineering</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Level 2</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Info gathering using Linux</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Windows memory management</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Assembly language basics</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Buffer overflows</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Metasploitframe Work</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >For detailed content kindly click here:</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >(provide the link for the course modules which is given in the proposal)</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ></span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >About Trainer: Sunny Vaghela (Director & CTO,TechDefence) - </span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Sunny Vaghela is 23 year old renowned Ethical Hacker & has wide experience in the field of Ethical Hacking,Cyber Crime Investigation & Forensics. At the age of 18, Sunny found many loopholes in SMS & VoIP Technology.At 19,Sunny has found loopholes like 'Session Hijacking' & 'Cross Site Scripting' in popular social networking website orkut.com.At 20, He has solved more than 16 cases in association with Crime Branch,Ahmedabad.Sunny Vaghela has also been awarded by Rajiv Gandhi Young Achievers Award as IT Expert of Gujarat.He traced out origin of Terror Email Trail of Ahmedabad Serial Bomb Blasts. He also helped Mumbai Police to get information on “jamat ud dawah” after Mumbai Terror Attacks.He has addressed more than 160 IT security conferences/Workshops at National & International Level across Globe.He has trained professionals from many reputed Companies like Google,Yahoo!,ISACA,Temenos,ZOHO, Deloitte,K7 Antivirus,TCS,HCL,Sify & many Banks of India. He is founder & Chief Technical Officer of TechDefence which is rapidly growing IT Security Training & Consulting Organization focusing on Cyber Crime Investigation,Cyber Law Consulting,Vulnerability Assessment & Penetration Testing.He is recently acknowledged by Microsoft for finding & reporting Vulnerabilities on Microsoft Online Services and now Listed in Microsoft Security Researcher List. To know more visit www.sunnyvaghela.com</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Workshop Package Includes:</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ></span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Workshop participation fee</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >TechDefence Ethical Hacking toolkit fee</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >CEHE certification fee</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >HackTrack Portal Access for 2 years.(www.hacktrack.co.in)</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ></span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >HackTrack Portal Features:</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ></span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Query support to all workshop participants.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Access to Online competition after the workshop in order to select topper of workshop.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Access to monthly competitions different tasks and challenges.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Access to Webinars on New tools/Techniques/Exploits/Vulnerabilities.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Internship/career opportunities from TechDefence associates & partners</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Weekly newsletters.</span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Resume submission </span><span id="blockGen522" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen525' style='background: rgba(217,213,214,0.8);'><img src="static/Icons_Final/AUGMENTED.png" width='250px'/></span><br />
<span id='blockGen526' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,236,206,0.8);' onclick='register_single_event(64)'><h3>Register</h3></span>
<span id='blockGen527' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,244,211,0.8);' onclick='getPage("Augmented_Reality","Augmented_Reality_Description")'><h3>Description</h3></span>
<span id='blockGen528' style='width:220px;padding: 15px;border-radius:20px;background: rgba(232,209,243,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen533'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(203,227,224,0.8);'><h1 style='text-align:center;font-family: acens;'>3D Photography</h1></button></span><br />
<span id='blockGen534' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,242,226,0.8);' onclick='register_single_event(68)'><h3>Register</h3></span>
<span id='blockGen535' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,227,213,0.8);' onclick='getPage("3D_Photography","3D_Photography_Description")'><h3>Description</h3></span>
<span id='blockGen536' style='width:220px;padding: 15px;border-radius:20px;background: rgba(225,239,238,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen541' style='background: rgba(234,224,228,0.8);'><img src="static/Icons_Final/RC_Aircraft.png" width='250px'/></span><br />
<span id='blockGen542' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,212,233,0.8);' onclick='register_single_event(65)'><h3>Register</h3></span>
<span id='blockGen543' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,232,226,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication_Workshop Details")'><h3>Workshop Details</h3></span>
<span id='blockGen544' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,203,232,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication_Workshop Specialties")'><h3>Workshop Specialties</h3></span>
<span id='blockGen545' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,235,229,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication_Description")'><h3>Description</h3></span>
<span id='blockGen546' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,219,248,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication_Kit Contents")'><h3>Kit Contents</h3></span>
<span id='blockGen547' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,230,223,0.8);' onclick='getPage("RC_Aircraft_Design_and_Fabrication","RC_Aircraft_Design_and_Fabrication_Workshop Structure")'><h3>Workshop Structure</h3></span>
<span id='blockGen548' style='width:220px;padding: 15px;border-radius:20px;background: rgba(212,208,226,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id="blockGen551" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Duration:  2 days (8 hours per day) </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Date:  25 Oct - 27 Oct 2013 </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Organizers: AerotriX </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Cost: Rs 7500/- per team for the standard kit and Rs 12500/- for the complete kit. </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Participants can register in team containing maximum of 5 members </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Visit www.aerotrix.com for further details </span><span id="blockGen550" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Write to us at info@aerotrix.com for further queries or information
</span>
</span>
...
• Hardware • Engine/ Electric Motor * • Electric Motor Controller * • Propeller * </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Transmitter * • Receiver * • Li-Po battery * • Servo motors (3 pieces) * </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Landing Gear ( main and tail dragger) • Wheels (2 pieces) • Coroplast • Styrofoam </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Control Rods • Epoxy Glue • Wing Holders • Working Tools ^ </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Other miscellaneous items The parts marked * are not part of standard kit. These components would be provided during the workshop but would be taken back after the workshop. This is being done to reduce the cost of the workshop and make it affordable for students who do not want to buy the complete kit. </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Complete kit consists of all the above items excluding transmitter and receiver </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > ^working tools would be taken back after workshop </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Software </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Software used to design and test RC planes • RC Simulator • RC Flying Tutorials and videos </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Other Material </span><span id="blockGen559" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Booklet on Aircraft Maintenance • Booklet on aerobatic maneuvers 
</span>
</span>
...
The workshop is divided into 4 modules: • Understanding Flight </span><span id="blockGen562" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Design of Aircraft </span><span id="blockGen562" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > • Fabrication of Aircraft </span><span id="blockGen562" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Flying using Remote Control </span><span id="blockGen562" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Three awards will be given to the participating teams in terms of Best Design, Best Fabrication and Innovation. The names of the recipients will be put up on our website permanently and they will also be provided with certificate of merit. For our previous workshops awards, check www.aerotrix.com/participant-awards
</span>
</span>
<span id = "tabs65_register">
<span id="blockGen564" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen565' style='background: rgba(240,225,231,0.8);'><img src="static/Icons_Final/ROBOTICS.png" width='250px'/></span><br />
<span id='blockGen566' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,228,213,0.8);' onclick='register_single_event(66)'><h3>Register</h3></span>
<span id='blockGen567' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,248,222,0.8);' onclick='getPage("Humanoid_Robot","Humanoid_Robot_Description")'><h3>Description</h3></span>
<span id='blockGen568' style='width:220px;padding: 15px;border-radius:20px;background: rgba(203,227,213,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen573' style='background: rgba(205,216,229,0.8);'><img src="static/Icons_Final/Android.png" width='250px'/></span><br />
<span id='blockGen574' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(232,200,231,0.8);' onclick='register_single_event(67)'><h3>Register</h3></span>
<span id='blockGen575' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(249,231,216,0.8);' onclick='getPage("Android Application Development","Android Application Development_Workshop Details")'><h3>Workshop Details</h3></span>
<span id='blockGen576' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(229,213,236,0.8);' onclick='getPage("Android Application Development","Android Application Development_Description")'><h3>Description</h3></span>
<span id='blockGen577' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(203,216,235,0.8);' onclick='getPage("Android Application Development","Android Application Development_Other Material")'><h3>Other Material</h3></span>
<span id='blockGen578' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,245,243,0.8);' onclick='getPage("Android Application Development","Android Application Development_Workshop Specialities")'><h3>Workshop Specialities</h3></span>
<span id='blockGen579' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,211,219,0.8);' onclick='getPage("Android Application Development","Android Application Development_Workshop structure")'><h3>Workshop structure</h3></span>
<span id='blockGen580' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,246,203,0.8);' onclick='getPage("Android Application Development","Android Application Development_Software")'><h3>Software</h3></span>
<span id='blockGen581' style='width:220px;padding: 15px;border-radius:20px;background: rgba(244,213,202,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<b>Duration</b>: 2 days (8 hours per day)</span><span id="blockGen583" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Date</b>: <b> 26 Oct - 27 Oct 2013</b></span><span id="blockGen583" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Organizers</b>: Code Instruct</span><span id="blockGen583" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Cost</b>: Rs 1200/- per participant</span><span id="blockGen583" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Booklet on Introduction to Android</span><span id="blockGen589" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Sample Applications in Android (Source Code)</span><span id="blockGen589" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<i>Interactive Lecture Sessions</i></span><span id="blockGen592" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><i>Hands on development of Android applications using industry standard tools</i></span><span id="blockGen592" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><i>The workshop is organized personally by IIT Kanpur Computer Science and Engineering Graduates</i></span><span id="blockGen592" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Introduction to Mobile Application Development</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Role of Android in mobile industry</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Introduction to Android SDK and its setup</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Building the Application Framework</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Designing User Interfaces</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Working with activities</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Working with Resources, Intents, Widgets</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Adding network support to the Application</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Examples apps: Calculator, Music Player and Battery Widget</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Publishing Application into Play Store</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Awards will be given to the participants, who develop innovative and interesting apps. The names of the recipients will be put up on our website permanently and they will also be provided with certificate of merit.</span><span id="blockGen595" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Software used to design and develop Android Applications</span><span id="blockGen598" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Eclipse IDE</span><span id="blockGen598" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Android SDK
</span>
</span>
...
<span id='blockGen601' style='background: rgba(230,224,242,0.8);'><img src="static/Icons_Final/Bridge_design.png" width='250px'/></span><br />
<span id='blockGen602' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,243,248,0.8);' onclick='register_single_event(69)'><h3>Register</h3></span>
<span id='blockGen603' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,210,218,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Course Details")'><h3>Course Details</h3></span>
<span id='blockGen604' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,228,239,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Awards")'><h3>Awards</h3></span>
<span id='blockGen605' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,210,215,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Description")'><h3>Description</h3></span>
<span id='blockGen606' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(200,244,224,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Course Content")'><h3>Course Content</h3></span>
<span id='blockGen607' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,240,218,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Workshop structure")'><h3>Workshop structure</h3></span>
<span id='blockGen608' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,248,228,0.8);' onclick='getPage("Bridge_Design_and_Fabrication","Bridge_Design_and_Fabrication_Outcomes")'><h3>Outcomes</h3></span>
<span id='blockGen609' style='width:220px;padding: 15px;border-radius:20px;background: rgba(226,231,222,0.8);'><h3>Contact: Manasij(+91 9738731680)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Duration: 1 day</span><span id="blockGen611" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Date: 24 October 2013</span><span id="blockGen611" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Organizers: Civil Simplified</span><span id="blockGen611" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Cost: Rs.950 per participant. 2 participants will be clubbed into a team during practical session. One team will design and make one bridge.</span><span id="blockGen611" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<b>Best Design Award</b>: To the team which builds the bridge with maximum efficiency</span><span id="blockGen614" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Best Fabrication Award</b>: To the team which fabricates the bridge perfectly</span><span id="blockGen614" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Best Innovation Award</b>: To the team which comes up with an innovative truss</span><span id="blockGen614" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Introduction to different types of existing bridges</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Structural response to moving loads</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Methods of analysis of a truss bridge</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >IRC code specifications</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Segmental Bridge Construction techniques</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Pre stressed box girder design</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Statically determinate and indeterminate structures</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Fabrication techniques for model bridge according to problem statement</span><span id="blockGen620" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
The workshop has the following modules:</span><span id="blockGen623" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Lecture</b>: Introduction to bridge design and working of different types of bridges</span><span id="blockGen623" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Design session</b>: Each team will design their own bridge using a simulator</span><span id="blockGen623" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Fabrication</b>: With the design obtained in the design session and the raw material provided by us each team will fabricate their own model bridge</span><span id="blockGen623" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Testing</b>: Each bridge fabricated by the teams will be tested for maximum load taken</span><span id="blockGen623" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Certificate of participation from Civil Simplified to all the participants</span><span id="blockGen626" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Career Guidance and Counseling by IIT alumni</span><span id="blockGen626" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Better Chances to pursue higher education in IITs/Universities abroad</span><span id="blockGen626" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Useful to develop good B.Tech/M.Tech projects</span><span id="blockGen626" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<td valign='top' style='width: 30%'>
<span id='sideMindBend'>
<span id='blockGen629' style='background: rgba(215,233,210,0.8);'><img src="static/Icons_Final/mindbend.png" width='250px'/></span><br />
<span id='blockGen630' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(243,245,220,0.8);' onclick='register_single_event(45)'><h3>Register</h3></span>
<span id='blockGen631' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,216,227,0.8);' onclick='getPage("MindBend","MindBend_ROUND 4")'><h3>ROUND 4</h3></span>
<span id='blockGen632' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,235,247,0.8);' onclick='getPage("MindBend","MindBend_ROUND 3")'><h3>ROUND 3</h3></span>
<span id='blockGen633' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,211,211,0.8);' onclick='getPage("MindBend","MindBend_ROUND 2")'><h3>ROUND 2</h3></span>
<span id='blockGen634' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,215,223,0.8);' onclick='getPage("MindBend","MindBend_ROUND 1")'><h3>ROUND 1</h3></span>
<span id='blockGen635' style='width:220px;padding: 15px;border-radius:20px;background: rgba(222,214,234,0.8);'><h3>Contact: B. THEJA<br/>+919480435585<br/>bnmtheja@gmail.com<br/>Padmini M<br/>+918123463865<br/>pm27178@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupMindBend">
...
<b>RAPIDO</b></span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >DESCRIPTION OF THE GAME:</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 5 rapid fire questions for each participant.</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >RULES:</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- No repetition of the questions.</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >JUDGEMENT CRITERIA:</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Each correct answer will carry 20 points.</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Total points for this round are 100.</span><span id="blockGen637" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There will be no negative marking for this round
</span>
</span>
...
<b>SOUNDTRACK</b></span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >DESCRIPTION OF THE GAME:</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- A one minute audio/ video clip would be listened/ shown to each team respectively;</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Team has to identify the theme of the audio/ video.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >RULES:</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There should be no repetition.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 20 points for correct answer.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Total points for this round are 40.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >TIME DURATION:</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- For audio &ndash; Max. 30 seconds.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- For video - According to the length of the video</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >JUDGEMENT CRITERIA:</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Time limit for thinking about the audio/ video should not be exceeding more than 15 seconds.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There will be negative marking system for this round.</span><span id="blockGen640" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Penalty of 10 points for incorrect answer.
</span>
</span>
...
<b> DOUBLE TROUBLE</b></span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >DESCRIPTION OF THE GAME:</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Teams have to identify the shown images along with their background/specialty.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >e.g.: If the given image is about the car, then participants should identify the manufacturer company of the car as well as the model of the car. </span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >RULES:</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There should be no repetition.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Each correct answer will carry 20 points.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Total points for this round are 60.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >TIME DURATION:</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 10 Seconds per image.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >JUDGEMENT CRITERIA:</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Points would be allotted for both identification of image and its background or specialty.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 10 points would be allotted for at least single identification of the image.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There will be a negative marking system in this round.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 10 points will be deducted for each incorrect answer.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- If one team is unable to identify the image, then it will be forward to next team.</span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- If the next team gives the correct answer, bonus of 5 points will be awarded, and </span><span id="blockGen643" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >if the respective team fails to answer correctly, then there will be a penalty of 10 points.
</span>
</span>
...
<b>REMINDER</b></span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >DESCRIPTION OF THE GAME:</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 10 minutes to solve the 15 multiple choice questions.</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >RULES:</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Each correct answer will carry 10 points.</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Total points for this round are 150.</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- There will be no negative marking system for this round.</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >TIME DURATION:</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 10 Minutes.</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >JUDGEMENT CRITERIA:</span><span id="blockGen646" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Points would not be awarded for more than one answer
</span>
</span>
<span id = "tabs45_register">
<span id="blockGen648" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen649' style='background: rgba(242,202,211,0.8);'><img src="static/Icons_Final/HR.png" width='250px'/></span><br />
<span id='blockGen650' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,246,228,0.8);' onclick='register_single_event(60)'><h3>Register</h3></span>
<span id='blockGen651' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(208,230,202,0.8);' onclick='getPage("HR_Event","HR_Event_Description")'><h3>Description</h3></span>
<span id='blockGen652' style='width:220px;padding: 15px;border-radius:20px;background: rgba(235,237,222,0.8);'><h3>Contact: Salman - 08904390686<br/>\ Aditya - 07353643231</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen657' style='background: rgba(212,247,206,0.8);'><img src="static/Icons_Final/MARKENZA.png" width='250px'/></span><br />
<span id='blockGen658' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(242,224,210,0.8);' onclick='register_single_event(38)'><h3>Register</h3></span>
<span id='blockGen659' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,212,223,0.8);' onclick='getPage("Markenza","Markenza_Description")'><h3>Description</h3></span>
<span id='blockGen660' style='width:220px;padding: 15px;border-radius:20px;background: rgba(220,231,237,0.8);'><h3>Contact: Salman Usman <br/>salman.usman91@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen665' style='background: rgba(228,236,210,0.8);'><img src="static/Icons_Final/Finance.png" width='250px'/></span><br />
<span id='blockGen666' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,232,212,0.8);' onclick='register_single_event(61)'><h3>Register</h3></span>
<span id='blockGen667' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,204,245,0.8);' onclick='getPage("Finance_Event","Finance_Event_Description")'><h3>Description</h3></span>
<span id='blockGen668' style='width:220px;padding: 15px;border-radius:20px;background: rgba(204,231,203,0.8);'><h3>Contact: Salman - 08904390686<br/>\ Aditya - 07353643231</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen673' style='background: rgba(242,238,250,0.8);'><img src="static/Icons_Final/SIMPLINEER.png" width='250px'/></span><br />
<span id='blockGen674' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(236,240,223,0.8);' onclick='register_single_event(40)'><h3>Register</h3></span>
<span id='blockGen675' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,240,201,0.8);' onclick='getPage("Simplineer","Simplineer_Proceedings")'><h3>Proceedings</h3></span>
<span id='blockGen676' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,221,203,0.8);' onclick='getPage("Simplineer","Simplineer_Description")'><h3>Description</h3></span>
<span id='blockGen677' style='width:220px;padding: 15px;border-radius:20px;background: rgba(234,226,219,0.8);'><h3>Contact: Saurabh Verma (9742091940)<br/>Sumit Bansal (9663358730)</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen683' style='background: rgba(247,239,239,0.8);'><img src="static/Icons_Final/IDP.png" width='250px'/></span><br />
<span id='blockGen684' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,236,202,0.8);' onclick='register_single_event(32)'><h3>Register</h3></span>
<span id='blockGen685' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(212,241,226,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem_Description")'><h3>Description</h3></span>
<span id='blockGen686' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,248,236,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem_Problem Statement")'><h3>Problem Statement</h3></span>
<span id='blockGen687' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,215,212,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem_Rules_and_Regulations")'><h3>Rules_and_Regulations</h3></span>
<span id='blockGen688' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(202,248,249,0.8);' onclick='getPage("Industry_Defined_Problem","Industry_Defined_Problem_Rounds")'><h3>Rounds</h3></span>
<span id='blockGen689' style='width:220px;padding: 15px;border-radius:20px;background: rgba(248,205,237,0.8);'><h3>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id="blockGen698" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
  A team can have a maximum of 4 people.  All members of the team are to be enrolled as students in an educational institute.  No person can be a part of more than 1 team.  </span><span id="blockGen697" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >There is no restriction on the number of people participating from a particular institute. </span><span id="blockGen697" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Cash prize of 30K for this event alone !!
</span>
</span>
...
<span id='blockGen703'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(212,221,240,0.8);'><h1 style='text-align:center;font-family: acens;'>Contraption</h1></button></span><br />
<span id='blockGen704' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,202,224,0.8);' onclick='register_single_event(70)'><h3>Register</h3></span>
<span id='blockGen705' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(246,248,218,0.8);' onclick='getPage("Contraption","Contraption_Introduction")'><h3>Introduction</h3></span>
<span id='blockGen706' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(233,209,226,0.8);' onclick='getPage("Contraption","Contraption_Problem Statement")'><h3>Problem Statement</h3></span>
<span id='blockGen707' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(234,224,200,0.8);' onclick='getPage("Contraption","Contraption_Rules")'><h3>Rules</h3></span>
<span id='blockGen708' style='width:220px;padding: 15px;border-radius:20px;background: rgba(204,223,209,0.8);'><h3>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen719' style='background: rgba(240,243,202,0.8);'><img src="static/Icons_Final/the_portal.png" width='250px'/></span><br />
<span id='blockGen720' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,210,234,0.8);' onclick='register_single_event(33)'><h3>Register</h3></span>
<span id='blockGen721' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(225,233,228,0.8);' onclick='getPage("The_Portal","The_Portal_Description")'><h3>Description</h3></span>
<span id='blockGen722' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,210,247,0.8);' onclick='getPage("The_Portal","The_Portal_FAQ")'><h3>FAQ</h3></span>
<span id='blockGen723' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(232,223,212,0.8);' onclick='getPage("The_Portal","The_Portal_Round 2")'><h3>Round 2</h3></span>
<span id='blockGen724' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,220,224,0.8);' onclick='getPage("The_Portal","The_Portal_Round 1")'><h3>Round 1</h3></span>
<span id='blockGen725' style='width:220px;padding: 15px;border-radius:20px;background: rgba(245,202,225,0.8);'><h3>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id="blockGen731" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 What pre-requisites are required to attend the workshop?<br /><b>Ans</b> : None. Basics of reactors and distillation column will be covered in the theory session.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Should I get my laptop?<br /><b>Ans</b> : Yes</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > What about the software and license of ChemCAD?<br /><b>Ans</b>: We will provide you the software. NITK chemical engineering department has licensed software and participants will be allowed to use the same.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > ChemCAD requires license? How can it be useful if I don’t have one?<br /><b>Ans</b>: ChemCAD is extensively used in industry as well as in research. Learning this software will give you a glimpse of how simulation works and knowing a simulating tool before graduation is always an added advantage.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > I am a first year/ second year student. I have no knowledge of reactors or distillation columns. Can I attend?<br /><b>Ans</b> : See Answer for Q. 1</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > I am an out-station participant. What about my stay?<br /><b>Ans</b>: Your stay at NITK will be managed by our student hospitality team.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Who will be conducting the workshop?<br /><b>Ans</b>: Students from NITK well versed with the software will be conducting the same.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > How do I register for the workshop?<br /><b>Ans</b>: Preregister by sending a mail to sra.10ch36@nitk.edu.in.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > I am not a chemical engineer. Can I attend?<br /><b>Ans</b>: This workshop is not restricted to chemical engineers as simulation is major aspect in design, research and process industries. See Q1.</span><span id="blockGen730" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id="blockGen734" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 <b>Event</b><hr />A series of problem statements will have to be solved using ChemCAD in a stipulated amount of time. The questions will be based on the knowledge acquired in round 1. The criteria for judgment will depend on several factors which will be announced on the spot. In case of any discrepancies, the decision of the organizers shall be considered final.</span><span id="blockGen733" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen739' style='background: rgba(214,229,234,0.8);'><img src="static/Icons_Final/Chemical_Breakdown.png" width='250px'/></span><br />
<span id='blockGen740' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,210,234,0.8);' onclick='register_single_event(34)'><h3>Register</h3></span>
<span id='blockGen741' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(207,241,229,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown_Introduction")'><h3>Introduction</h3></span>
<span id='blockGen742' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,246,235,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown_rules")'><h3>rules</h3></span>
<span id='blockGen743' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(215,230,235,0.8);' onclick='getPage("Chemical_Breakdown","Chemical_Breakdown_rounds")'><h3>rounds</h3></span>
<span id='blockGen744' style='width:220px;padding: 15px;border-radius:20px;background: rgba(234,239,208,0.8);'><h3>Contact: Ramya<br/>sra.10ch36@nitk.edu.in <br/> 9538703009</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id="blockGen754" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen755' style='background: rgba(224,216,225,0.8);'><img src="static/Icons_Final/INSCRIPTION.png" width='250px'/></span><br />
<span id='blockGen756' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,204,227,0.8);' onclick='register_single_event(54)'><h3>Register</h3></span>
<span id='blockGen757' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,229,213,0.8);' onclick='getPage("Inscription","Inscription_Description")'><h3>Description</h3></span>
<span id='blockGen758' style='width:220px;padding: 15px;border-radius:20px;background: rgba(229,221,243,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Inscription is the international online programming contest of Engineer.</span><span id="blockGen760" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The contest will consist of a set of challenging problems to which solutions need to be submitted which adhere to time constraints. Programming, debugging and fine-tuning skills are tested to the very hilt.</span><span id="blockGen760" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Teams of 3.</b>
</span>
</span>
...
<span id='blockGen763' style='background: rgba(220,216,220,0.8);'><img src="static/Icons_Final/ECTF.png" width='250px'/></span><br />
<span id='blockGen764' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(225,244,218,0.8);' onclick='register_single_event(55)'><h3>Register</h3></span>
<span id='blockGen765' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,239,211,0.8);' onclick='getPage("ECTF_-_Capture_the_Flag","ECTF_-_Capture_the_Flag_Description")'><h3>Description</h3></span>
<span id='blockGen766' style='width:220px;padding: 15px;border-radius:20px;background: rgba(250,239,234,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
ECTF is a ethical hacking competition, where you set up your Base (a virtual machine) with the&nbsp; Flag (a special file) that we will provide. Hack into your enemy's Base and retrieve his Flag, while&nbsp; at the same time defending your own.</span><span id="blockGen768" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Teams of 3.</b></span><span id="blockGen768" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
<span id = "tabs55_register">
<span id="blockGen770" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen771' style='background: rgba(236,203,226,0.8);'><img src="static/Icons_Final/VIRTUAL_BOUNTY2.png" width='250px'/></span><br />
<span id='blockGen772' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,231,237,0.8);' onclick='register_single_event(56)'><h3>Register</h3></span>
<span id='blockGen773' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(249,242,217,0.8);' onclick='getPage("Virtual_Bounty","Virtual_Bounty_Description")'><h3>Description</h3></span>
<span id='blockGen774' style='width:220px;padding: 15px;border-radius:20px;background: rgba(220,228,215,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Virtual Bounty is the online technical treasure hunt of Engineer, where the divine 'Googling' skills&nbsp; of the participants are put to test. Using search engines, the participants need to figure out the clues&nbsp; which will take them all around the World Wide Web in order to get to the next more intriguing&nbsp; level. This is a quest for the elusive treasure buried beneath billions of web pages.</span><span id="blockGen776" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Individual event</b>
</span>
</span>
<span id = "tabs56_register">
<span id="blockGen778" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen779' style='background: rgba(225,205,216,0.8);'><img src="static/Icons_Final/CODE_KOMBAT.png" width='250px'/></span><br />
<span id='blockGen780' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,213,208,0.8);' onclick='register_single_event(57)'><h3>Register</h3></span>
<span id='blockGen781' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(241,204,205,0.8);' onclick='getPage("Kode_Kombat","Kode_Kombat_Description")'><h3>Description</h3></span>
<span id='blockGen782' style='width:220px;padding: 15px;border-radius:20px;background: rgba(231,221,242,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen787' style='background: rgba(234,228,207,0.8);'><img src="static/Icons_Final/marathon_final.png" width='250px'/></span><br />
<span id='blockGen788' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,203,208,0.8);' onclick='register_single_event(58)'><h3>Register</h3></span>
<span id='blockGen789' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,249,213,0.8);' onclick='getPage("Marathon","Marathon_Description")'><h3>Description</h3></span>
<span id='blockGen790' style='width:220px;padding: 15px;border-radius:20px;background: rgba(227,229,204,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<td valign='top' style='width: 30%'>
<span id='sideRectify'>
<span id='blockGen795' style='background: rgba(201,201,244,0.8);'><img src="static/Icons_Final/RECTIFY.png" width='250px'/></span><br />
<span id='blockGen796' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,246,250,0.8);' onclick='register_single_event(59)'><h3>Register</h3></span>
<span id='blockGen797' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(213,228,239,0.8);' onclick='getPage("Rectify","Rectify_Description")'><h3>Description</h3></span>
<span id='blockGen798' style='width:220px;padding: 15px;border-radius:20px;background: rgba(236,205,212,0.8);'><h3>Contact: Syed Rahi(9880016036) <br/>srsyedrahi@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupRectify">
<span id = "tabsRectify_Description">
<span id="blockGen799" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen801" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
It’s time to scratch your Grey cells, it’s time to rectify! Rectify will test your hunting instincts. Can&nbsp; you spot your prey and catch it at the blink of an eye like the vicious vulture ? If you think you have&nbsp; a sharp eye and the instincts of a predator programmer, then come and hunt for the errors in our&nbsp; codes. This event not only tests the mastery over and familiarity with a programming language but&nbsp; also your dexterity in analyzing problems and providing logical solutions.</span><span id="blockGen800" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Individual event</b></span><span id="blockGen800" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
<span id = "tabs59_register">
<span id="blockGen802" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<td valign='top' style='width: 30%'>
<span id='sidemindBend'>
<span id='blockGen803' style='background: rgba(219,212,242,0.8);'><img src="static/Icons_Final/mindbend.png" width='250px'/></span><br />
<span id='blockGen804' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,206,211,0.8);' onclick='register_single_event(7)'><h3>Register</h3></span>
<span id='blockGen805' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,244,235,0.8);' onclick='getPage("mindBend","mindBend_Description")'><h3>Description</h3></span>
<span id='blockGen806' style='width:220px;padding: 15px;border-radius:20px;background: rgba(221,229,206,0.8);'><h3>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupmindBend">
<span id = "tabsmindBend_Description">
<span id="blockGen807" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen809" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
Mindbend is a fun quiz for those who have an undying thirst to know more about materials. It tests the participants’ knowledge of obscure and unnoticed facts about materials in an interactive and fascinating new format.</span><span id="blockGen808" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Prelims round consisting of crossword and short questionnaire.</span><span id="blockGen808" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Final round between 6 teams
</span>
</span>
...
<span id='blockGen811' style='background: rgba(209,224,232,0.8);'><img src="static/Icons_Final/SEMTEMExpo.png" width='250px'/></span><br />
<span id='blockGen812' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,202,233,0.8);' onclick='register_single_event(8)'><h3>Register</h3></span>
<span id='blockGen813' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(212,219,246,0.8);' onclick='getPage("SEM_and_TEM_Expo","SEM_and_TEM_Expo_Description")'><h3>Description</h3></span>
<span id='blockGen814' style='width:220px;padding: 15px;border-radius:20px;background: rgba(229,203,226,0.8);'><h3>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupSEM_and_TEM_Expo">
<span id = "tabsSEM_and_TEM_Expo_Description">
<span id="blockGen815" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen817" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
The event’s agenda is to exhibit two Electron Microscopes which are the pride of the Department and College.</span><span id="blockGen816" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 1 hour introductory talk</span><span id="blockGen816" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- 1 hour demo  </span><span id="blockGen816" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen819' style='background: rgba(201,201,231,0.8);'><img src="static/Icons_Final/MetaMagic.png" width='250px'/></span><br />
<span id='blockGen820' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,212,241,0.8);' onclick='register_single_event(9)'><h3>Register</h3></span>
<span id='blockGen821' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(230,208,236,0.8);' onclick='getPage("MetaMagic","MetaMagic_Description")'><h3>Description</h3></span>
<span id='blockGen822' style='width:220px;padding: 15px;border-radius:20px;background: rgba(234,214,223,0.8);'><h3>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupMetaMagic">
<span id = "tabsMetaMagic_Description">
<span id="blockGen823" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen825" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
Metamagic is an exhibition of fascinating experiments designed to amaze even the most skeptical. From Shape memory alloys to smoke bombs to walking on fluids, these dazzling displays will showcase the amazing nature of materials.</span><span id="blockGen824" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > - Major demonstrations  – Shape Memory Alloy, Superconductor</span><span id="blockGen824" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > - Others –  Sugar bomb, Instant Ice, Mega Bubble, Elephant Toothpaste, Walking on Water,  Chemical Squid, Smoke Bomb, Dry Sand.</span><span id="blockGen824" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
<span id = "tabs9_register">
<span id="blockGen826" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen827' style='background: rgba(219,232,209,0.8);'><img src="static/Icons_Final/SEMphotography.png" width='250px'/></span><br />
<span id='blockGen828' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,238,201,0.8);' onclick='register_single_event(10)'><h3>Register</h3></span>
<span id='blockGen829' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,202,236,0.8);' onclick='getPage("SEM_Photography_Contest","SEM_Photography_Contest_Description")'><h3>Description</h3></span>
<span id='blockGen830' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(205,208,216,0.8);' onclick='getPage("SEM_Photography_Contest","SEM_Photography_Contest_Submissiion Format")'><h3>Submissiion Format</h3></span>
<span id='blockGen831' style='width:220px;padding: 15px;border-radius:20px;background: rgba(250,235,221,0.8);'><h3>Contact: Vijay Bharadwaj J <br/> +919483478667 <br/> jvijay1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
The event is a photography contest. SEM and TEM images of samples having unique features are evaluated.</span><span id="blockGen833" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Online photo submission with description</span><span id="blockGen833" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
A PDF file containing Caption, Photo and a description of maximum 100 words should be sent to:</span><span id="blockGen836" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <b>materials.engi@gmail.com</b></span><span id="blockGen836" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >by 22nd October
</span>
</span>
<span id = "tabs10_register">
<span id="blockGen838" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen839' style='background: rgba(227,244,233,0.8);'><img src="static/Icons_Final/PRODUCT_DESIGN_123.png" width='250px'/></span><br />
<span id='blockGen840' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(212,209,211,0.8);' onclick='register_single_event(11)'><h3>Register</h3></span>
<span id='blockGen841' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,234,243,0.8);' onclick='getPage("Product_Design_Challenge","Product_Design_Challenge_Description")'><h3>Description</h3></span>
<span id='blockGen842' style='width:220px;padding: 15px;border-radius:20px;background: rgba(205,228,249,0.8);'><h3>Contact: Neetesh Hegde <br/> 9483647944</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupProduct_Design_Challenge">
<span id = "tabsProduct_Design_Challenge_Description">
<span id="blockGen843" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen845" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
The competition aims to test how one can optimize a design and create a sustainable design to provide the best solution to a real world problem. </span><span id="blockGen844" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The participants will be given a problem statement with the minimum requirements of a product. </span><span id="blockGen844" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The aim is to optimise the design and develop the best blue print for the problem.</span><span id="blockGen844" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The design would be judged by the company providing the problem statement, and will be accepting the best design to develop a final product.</span><span id="blockGen844" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Problem Statement Requirements:</b> Socially Conscious and Economical</span><span id="blockGen844" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen847' style='background: rgba(210,212,240,0.8);'><img src="static/Icons_Final/campussocialinnovation.png" width='250px'/></span><br />
<span id='blockGen848' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,208,222,0.8);' onclick='register_single_event(12)'><h3>Register</h3></span>
<span id='blockGen849' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,201,211,0.8);' onclick='getPage("Campus_Social_Innovision_Challenge","Campus_Social_Innovision_Challenge_Description")'><h3>Description</h3></span>
<span id='blockGen850' style='width:220px;padding: 15px;border-radius:20px;background: rgba(249,246,220,0.8);'><h3>Contact: Neetesh Hegde <br/> 9483647944</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupCampus_Social_Innovision_Challenge">
<span id = "tabsCampus_Social_Innovision_Challenge_Description">
<span id="blockGen851" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen853" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
The competition aims at solving problems within the campus of NITK-Surathkal.</span><span id="blockGen852" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >You will have to deal with the challenges which students of NITK face. </br>The team with the best solution to the given problem statement will get to implement their solution with support from EFOREA.</span><span id="blockGen852" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Problem Statement:</b> To be provided by NITK centre for Innovation and Learning.</span><span id="blockGen852" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
<span id = "tabs12_register">
<span id="blockGen854" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen855' style='background: rgba(249,204,234,0.8);'><img src="static/Icons_Final/casestudychallenge.png" width='250px'/></span><br />
<span id='blockGen856' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(214,247,242,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Case 2")'><h3>Case 2</h3></span>
<span id='blockGen857' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,212,247,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Case 3")'><h3>Case 3</h3></span>
<span id='blockGen858' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,241,227,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Description")'><h3>Description</h3></span>
<span id='blockGen859' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,235,205,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Agenda")'><h3>Agenda</h3></span>
<span id='blockGen860' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,246,250,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Introduction")'><h3>Introduction</h3></span>
<span id='blockGen861' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(234,233,243,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Register")'><h3>Register</h3></span>
<span id='blockGen862' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,244,200,0.8);' onclick='getPage("Case_Study_challenge","Case_Study_challenge_Case 1")'><h3>Case 1</h3></span>
<span id='blockGen863' style='width:220px;padding: 15px;border-radius:20px;background: rgba(240,238,222,0.8);'><h3>Contact: Neetesh Hegde <br/> 9483647944</h3></span>
</span>
</td>
<td style='width: 70%'>
...
The event aims to solve real case studies provided by corporate companies or small and medium enterprises (SMEs) and start-ups.</span><span id="blockGen871" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The participants are going to be provided with a problem statement from are partner companies.</span><span id="blockGen871" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Participants will have to present their solutions in the form of an elaborate presentation before the judges which will include the representatives of our partner companies.</span><span id="blockGen871" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Problem Statement Theme:</b> SUSTAINABILITY</span><span id="blockGen871" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
The <b>Intuit Case Study Challenge</b> provides the participants an opportunity to solve real world problems faced by businesses in various fields. The participants are provided with 3 case studies, out of which they can choose to present either one of the case studies. The competition is divided into 2 rounds:</span><span id="blockGen877" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 1st Round: Registration and submission of preliminary presentations </span><span id="blockGen877" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >2nd Round: Mentoring session and Finals (25th October, 2013 and 26th October, 2013.</span><span id="blockGen877" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <b>The deadline for 1st round submission is 19th October,2013. </b></span><span id="blockGen877" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The entries have to be submitted in the form of a powerpoint presentation only, to bizevents@engineer.org.in .</span><span id="blockGen877" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Participants have to register before submitting the entries.
</span>
</span>
...
<span id='blockGen885' style='background: rgba(249,204,235,0.8);'><img src="static/Icons_Final/data_analysischallenge.png" width='250px'/></span><br />
<span id='blockGen886' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,239,232,0.8);' onclick='register_single_event(14)'><h3>Register</h3></span>
<span id='blockGen887' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,243,214,0.8);' onclick='getPage("Data_Analysis_Challange","Data_Analysis_Challange_Description")'><h3>Description</h3></span>
<span id='blockGen888' style='width:220px;padding: 15px;border-radius:20px;background: rgba(225,249,229,0.8);'><h3>Contact: Neetesh Hegde <br/> 9483647944</h3></span>
</span>
</td>
<td style='width: 70%'>
...
This competition will judge your potential to deal with huge databases similar to big data.</span><span id="blockGen890" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The participants are going to be provided with a company’s database which they have to analyse in the most efficient way to provide the company a better system to analyse their own data in future.</span><span id="blockGen890" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Problem Statement: To be provided by a Business Analysis Company.</span><span id="blockGen890" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen893' style='background: rgba(210,206,239,0.8);'><img src="static/Icons_Final/BluePrint.png" width='250px'/></span><br />
<span id='blockGen894' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(244,203,203,0.8);' onclick='getPage("Blue_Print","Blue_Print_Description")'><h3>Description</h3></span>
<span id='blockGen895' style='width:220px;padding: 15px;border-radius:20px;background: rgba(245,205,238,0.8);'><h3>Contact: Raghavan<br/>+91-9590390285<br/>raghav10rogers@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<b>Introduction</b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Blueprint, the paper presentation contest held as part of Engineer attracts some of the best minds from all over the country. Participants are invited to present papers spanning various research topics pertaining to the different branches of engineering.</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>GENERAL RULES</b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Submissions are invited pertaining to novel research ideas and implementations in any of the above fields. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• The submissions should be original work by the authors and any hint of plagiarism will lead to instant disqualification.</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Authors are not permitted to submit papers that have already been accepted for publication/presentation in any other conferences or journals. Also, authors may not submit work that is under review in journals/conferences. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Authors cannot submit the same paper in more than one of the fields. Send the abstract as a PDF attachment to raghav10rogers@gmail.com</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• All paper-abstracts will undergo a blind-review process. This means that the authors are not to reveal their identity in ANY form in the abstracts. Authors are only required to mention their names and details in the appropriate section while uploading the abstract. Any attempt to reveal the author’s identity in the submitted abstract will lead to disqualification.</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• If the abstract is selected, then at least one of the authors has to be present for the final presentation. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>ABSTRACT SUBMISSION RULES AND PROCEDURE</b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Authors will need to submit a single page abstract for the initial selections. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• There is no specific format for the abstract. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Mention the title of the paper and DO NOT mention the authors name or author-affiliations. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• The abstract should not exceed 500 words in length and can include tables, figures or other data that the authors feel will improve the chances of their paper being selected. (The word limit is exclusive of the references and the title).</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Abstracts which do not comply with the above mentioned rules will be disqualified. </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>TEAMS OF 4</b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Submission Details</b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Send the abstract as a PDF attachment to raghav10rogers@gmail.com</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Subject of the mail: Category/ Field of Blueprint ( Example: Mechanical)</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >- Details to be included in the mail:</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Sample Format (Use this format in the mail)</span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><table border='1'>	<tr>		<td>Title of Paper</td>		<td>Name and Institution name of each author of the paper</td>		<td>Complete Contact Information of Participant (any one)</td>	</tr>	<tr>		<td>Analysis of Android mobile applications</td>		<td>Ram Prasad – NITK, Surathkal  Kishore Kumar – NITK, Surathkal</td>		<td>Ram Prasad  Email: ram@nitk.ac.in  Ph: 973082719 </td>	</tr></table><b>IMPORTANT DATES </b></span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >18th Oct – Deadline for submission of abstracts (Abstracts will be accepted till 11.59 PM) </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >21st Oct – Declaration of Selected papers </span><span id="blockGen897" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >24th -27th Oct – Presentation of papers
</span>
</span>
</span>
</td>
...
<span id='blockGen899' style='background: rgba(215,217,209,0.8);'><img src="static/Icons_Final/Velocity.png" width='250px'/></span><br />
<span id='blockGen900' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,207,243,0.8);' onclick='register_single_event(27)'><h3>Register</h3></span>
<span id='blockGen901' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(230,213,210,0.8);' onclick='getPage("Velocity","Velocity_General Rules")'><h3>General Rules</h3></span>
<span id='blockGen902' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,226,233,0.8);' onclick='getPage("Velocity","Velocity_Event Format")'><h3>Event Format</h3></span>
<span id='blockGen903' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(218,240,229,0.8);' onclick='getPage("Velocity","Velocity_Propulsion & Steering")'><h3>Propulsion & Steering</h3></span>
<span id='blockGen904' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(243,240,202,0.8);' onclick='getPage("Velocity","Velocity_Car Specs")'><h3>Car Specs</h3></span>
<span id='blockGen905' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(242,231,202,0.8);' onclick='getPage("Velocity","Velocity_Introduction")'><h3>Introduction</h3></span>
<span id='blockGen906' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(246,244,232,0.8);' onclick='getPage("Velocity","Velocity_Arena Specs")'><h3>Arena Specs</h3></span>
<span id='blockGen907' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,225,249,0.8);' onclick='getPage("Velocity","Velocity_Event Rules")'><h3>Event Rules</h3></span>
<span id='blockGen908' style='width:220px;padding: 15px;border-radius:20px;background: rgba(230,234,216,0.8);'><h3>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupVelocity">
<span id = "tabsVelocity_General Rules">
<span id="blockGen909" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen920" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 Machine should fit in a box of dimensions 500 mm x 500 mm x 400 mm (L X B X H) at any moment of time during the race.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The height will be measured excluding the antenna. The external device which is used to control the machine is not included in the size constraint.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The machine should be controlled by a wireless remote control mechanism throughout the race.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The machine must not be made from Lego parts, or any ready-made assembly kits other than the parts mentioned below.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Readily available chassis layouts are not allowed. Any machine found having a readymade chassis will be immediately disqualified.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The machine may be roughly classified into structural and functional parts:</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <b>Structural parts</b> - Chassis, shock mounting members and have to be built by the participants themselves.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <img src='data/velocity1.JPG'/> </span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <b>Functional Parts</b> – Stock Steering mechanism must not be used and suspension (lower excluding suspension spring and shock absorbers) has to be built by the participants themselves.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Steering mechanisms have to be compulsorily built by the participants.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Judging for the same will be strict and the participant will be immediately disqualified if any of the above structural components are found to be ready made.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The tires used must have a minimum diameter of 3 inches. You are advised to use tyres of good width for better performance on dirt tracks.<br\> <img src='data/velocity2.JPG'/></span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <b>Please note: It is not compulsory to fabricate the brake mechanism.</b></span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b>Wheel Hub:</b> Any part rigidly attached to the wheel hub will be considered as a part of it and hence can be ready-made. An example here is that of the ball stud. <img src='data/velocity3.JPG'/> </span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b> Steering Mechanism:</b> Any part which is connected to steering rod rigidly i.e. has no degrees of freedom with respect to steering rod (example: heim joint http://en.wikipedia.org/wiki/Heim_joint) will be considered as part of steering rod and thus has to be fabricated by participants.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/velocity4.JPG' /></span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><b> Suspension mechanism:</b> Any part rigidly connected to suspension arms or one with no degrees of freedom with respect to suspension arm will be considered as its part and has to be fabricated by the participants, except the upper suspension arm. For example both the heim joint (http://en.wikipedia.org/wiki/Rod_end_bearing -see this for more information) for the upper suspension arm and the stud rigidly connected to the wheel hub can be bought from the market.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/velocity5.JPG' /></span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If there are parts used in the concerned joint which are neither rigidly connected with suspension or the hub, steering system or hub; they can be used readymade from the market.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > If teams get any part specifically manufactured for them, they are required to present the CAD Drawings given to the manufacturer and the manufacturer’s bill for the same.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The Chassis has to be strictly built by the team and use of stock chassis will lead to immediate disqualification.</span><span id="blockGen919" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The above pictures are just sample pictures for you to understand the rules easily.
</span>
</span>
...
<span id="blockGen926" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 The design of the track will be updated periodically. ( Make a note to check out the website periodically)</span><span id="blockGen925" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The actual track during the time of race might not strictly follow the design shown above.</span><span id="blockGen925" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The width of the track varies from 0.5 m to a maximum of 2mts.
</span>
</span>
...
The final 3 rounds will have races with multiple cars racing at a time.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The track will have check points at regular intervals. If a machine tumbles, or halts, or goes off the arena at any point on the track, one of the team members is allowed to lift it up and place it at the nearest checkpoint behind that point. The clock will keep running during this time.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Only ONE member of the team will be allowed to run along with the car throughout each race.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Team members are not permitted to touch either their machines or those of their opponents once the race begins (unless there is a need to lift the machine as stated in second point). The penalty for doing so is disqualification.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > If any of the machines starts off before the flag is waved, the counter would be restarted and the machines will get a second chance. However, if any machine starts off before the waving of flag (or countdown) for a second time, it will be disqualified. </span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >No re-match will be offered for the second time.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The machines are not allowed to leave any loose parts on any part of the arena. Any machine disintegrating during the race will be disqualified.</span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Teams are not allowed to purposefully damage the machine of the opponent's team. If found doing so on track (while racing), the concerned team will be disqualified. </span><span id="blockGen928" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Execution of last three rules will be subjective and relies completely on judges' discretion.
</span>
</span>
...
<td valign='top' style='width: 30%'>
<span id='sideProteus'>
<span id='blockGen931' style='background: rgba(220,225,206,0.8);'><img src="static/Icons_Final/Proteus.png" width='250px'/></span><br />
<span id='blockGen932' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,238,209,0.8);' onclick='register_single_event(28)'><h3>Register</h3></span>
<span id='blockGen933' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,219,210,0.8);' onclick='getPage("Proteus","Proteus_Scoring")'><h3>Scoring</h3></span>
<span id='blockGen934' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,208,226,0.8);' onclick='getPage("Proteus","Proteus_download")'><h3>download</h3></span>
<span id='blockGen935' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,236,222,0.8);' onclick='getPage("Proteus","Proteus_Event Format")'><h3>Event Format</h3></span>
<span id='blockGen936' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(228,200,240,0.8);' onclick='getPage("Proteus","Proteus_General Rules")'><h3>General Rules</h3></span>
<span id='blockGen937' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,235,232,0.8);' onclick='getPage("Proteus","Proteus_Bot Specs")'><h3>Bot Specs</h3></span>
<span id='blockGen938' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(225,244,228,0.8);' onclick='getPage("Proteus","Proteus_Event Rules")'><h3>Event Rules</h3></span>
<span id='blockGen939' style='width:220px;padding: 15px;border-radius:20px;background: rgba(206,218,207,0.8);'><h3>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Time taken in round 1 = t1</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Time taken for destroying target 1 = t2 (seconds)</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Time taken for destroying target 2 = t3 (seconds)</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Time taken for destroying target 3 = t4 (seconds) </span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >T4 will be calculated only after all three targets have been brought down.</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Time remaining after all the targets have been destroyed = t5 (seconds)</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Range of the jet in round 1 = R (cm)</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >FIRST ROUND EVALUATION:</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >S1 = 2 * R * ( 1 / t1 )</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Based on S1, top eight teams are qualified for the next round and awarded points from 40 to 5 (40, 35, 30 .. and so on). These points are carried forward for the final score.</span><span id="blockGen941" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Final Score, S = ( ( 1000 / t2 ) + ( 2000 / t3 ) + ( 3000 / t4 ) ) * exp( ts / 100 )  + (Points carried forward from the first round)
</span>
</span>
...
<span id="blockGen945" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
 <a href='proteus.pdf'>Download</a></span><span id="blockGen944" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
• Participants must carry valid ID cards of their respective college, which must be produced at the time of registration.</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Maximum number of participants per team is four.</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Readymade kits are not allowed.</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Each team is allowed to participate with not more than one bot.</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >• Judges decision will be final and binding.</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Prizes: 1st: Rs. 4,000</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 2nd: Rs. 3,000</span><span id="blockGen950" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 3rd: Rs. 2,000<br /><b>Schedule</b><br /> Day 0 (23) Wave mechanics lab
</span>
</span>
...
<span id='blockGen959' style='background: rgba(227,232,237,0.8);'><img src="static/Icons_Final/PerfectMachine.png" width='250px'/></span><br />
<span id='blockGen960' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(223,229,220,0.8);' onclick='register_single_event(29)'><h3>Register</h3></span>
<span id='blockGen961' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,226,237,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_arenaspecs")'><h3>arenaspecs</h3></span>
<span id='blockGen962' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,248,222,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_eventformat")'><h3>eventformat</h3></span>
<span id='blockGen963' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,223,242,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_judging")'><h3>judging</h3></span>
<span id='blockGen964' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,202,201,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_specifications")'><h3>specifications</h3></span>
<span id='blockGen965' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(216,223,216,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_generalrules")'><h3>generalrules</h3></span>
<span id='blockGen966' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(201,215,200,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_mobility")'><h3>mobility</h3></span>
<span id='blockGen967' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,201,239,0.8);' onclick='getPage("PerfectMachine","PerfectMachine_download")'><h3>download</h3></span>
<span id='blockGen968' style='width:220px;padding: 15px;border-radius:20px;background: rgba(238,213,220,0.8);'><h3>Contact: Akshay K R <br/>koodlyakshay@gmail.com<br/>9731937661</h3></span>
</span>
</td>
<td style='width: 70%'>
...
The dimensions of the bridge are as indicated</span><span id="blockGen970" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/mech1.png'/></span><span id="blockGen970" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Fig 2: paths that the teams are required to use</span><span id="blockGen970" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/mech2.png'/></span><span id="blockGen970" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Fig 3: The dimensions of the bridge</span><span id="blockGen970" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Each round will be of a maximum of 15 min duration.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Fig 1 portrays the arena </span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Each bot must have a mechanism to lift the objects(it will be a ball or a cube) kept in rectangular container and throw them into the hoops kept at different heights </span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In each hoop only a maximum of 3 objects (1 ball and 2 cubes) can be thrown.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Hoop 1 will be at the ground level. Hoop 2 will be at the height of 15cm from the arena. Hoop 3 will be at the height of 25cm from the arena. </span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >A bridge will be provided at the bottom of hoop 3(hoop at the height of 25 cm). The bot is required to climb over this bridge and throw the objects in hoop 3.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Each bot will be given only one round in which they need to complete the task.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If the bot gets immobilized (unable to show minimum linear displacement of 10cm for 30 seconds) or toppled over, those teams cannot ask for restore.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The organizers reserve the right to change any or all of the above rules as they deem fit.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Violation of any the above rules will lead to disqualification.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Judges' decision shall be treated as final and binding on all.</span><span id="blockGen973" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
A task is considered as completed only if all the objects are thrown into yhe respective hoops in.</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The score given to each team at the end of their trial as follows</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Score = ((10*h1+20*h2+40*h3) *t</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Where,</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >t= Time remaining after the completion of the task (in minutes) (only after 9 objects are thrown).</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >h1= Number of objects thrown in hoop 1(max=3).</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >h2= Number of objects thrown in hoop 2(max=3).</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >h3= Number of objects thrown in hoop 3(max=3).</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case of a tie,</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Number of balls put will be considered. If scores are level even after that, the team to complete the task fastest will be awarded as winners.</span><span id="blockGen976" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
BOT SPECIFICATIONS</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The initial bot dimensions should not exceed 30 x 30 x 20 cm3&#160;excluding the control device dimensions. This dimension excludes the dimension of lifting mechanism </span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The weight of the bot should not exceed 15 kgs.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The bot can be controlled wirelessly or with wires.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Readymade wireless remote control units may be used.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case wired control is used, the wire(s) must remain slack throughout the event. If the wires are visibly taut, the team would be immediately disqualified.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Single phase external 230V AC power will be supplied. Maximum voltage between any two points on the bot must not exceed 24 V DC or 24 V AC.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >OBJECT DIMENSION</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Total number of objects to be thrown =9.</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The dimension of each cube=a cm*a cm*a cm</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The diameter of each ball = a cm</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The diameter of the hoop=20cm</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >a = 4 to 7</span><span id="blockGen979" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
<span id = "tabsPerfectMachine_generalrules">
<span id="blockGen981" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen983" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
The students must carry valid student ID cards of their college which they will be required to produce at the time of registration.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Contestants will have to register online. On spot registrations can also be done.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >A team may comprise a maximum of FIVE participants.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Readymade kits are NOT allowed. Judges decision in this regard will be final and binding.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The team is not permitted to compete with more than one bot.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Teams will not be allowed to modify their bots during their trial.</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Prizes:</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 1st: Rs. 6,000</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 2nd: Rs. 4,000</span><span id="blockGen982" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 3rd: Rs. 2,000<br /><b>Schedule</b><br /> Day 1 (24) Sports complex
</span>
</span>
<span id = "tabsPerfectMachine_mobility">
<span id="blockGen984" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
<span id="blockGen986" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
&#160;All robots must have easily visible and controlled mobility in order to compete.&#160;</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Any machine component should not be detached (intentionally) during any point of the event.</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Methods of Mobility include:</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Rolling (wheels, tracks or the whole robot)</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Walking (linear actuated legs with no rolling or cam operated motion).</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Shuffling(rotational cam operated legs)</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Jumping and hopping is not allowed</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Flying (airfoil using, helium balloons, ornithopters, hovercrafts etc.) is not allowed.</span><span id="blockGen985" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen991' style='background: rgba(231,237,226,0.8);'><img src="static/Icons_Final/RoboWars.png" width='250px'/></span><br />
<span id='blockGen992' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,227,248,0.8);' onclick='register_single_event(30)'><h3>Register</h3></span>
<span id='blockGen993' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,228,238,0.8);' onclick='getPage("Robowars","Robowars_power")'><h3>power</h3></span>
<span id='blockGen994' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(242,217,225,0.8);' onclick='getPage("Robowars","Robowars_mobility")'><h3>mobility</h3></span>
<span id='blockGen995' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,246,237,0.8);' onclick='getPage("Robowars","Robowars_botspecs")'><h3>botspecs</h3></span>
<span id='blockGen996' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(249,238,225,0.8);' onclick='getPage("Robowars","Robowars_eventrules")'><h3>eventrules</h3></span>
<span id='blockGen997' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(207,236,239,0.8);' onclick='getPage("Robowars","Robowars_arenaspecs")'><h3>arenaspecs</h3></span>
<span id='blockGen998' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(219,238,239,0.8);' onclick='getPage("Robowars","Robowars_eventformat")'><h3>eventformat</h3></span>
<span id='blockGen999' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(225,200,222,0.8);' onclick='getPage("Robowars","Robowars_download")'><h3>download</h3></span>
<span id='blockGen1000' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(249,250,249,0.8);' onclick='getPage("Robowars","Robowars_weapon")'><h3>weapon</h3></span>
<span id='blockGen1001' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(242,202,241,0.8);' onclick='getPage("Robowars","Robowars_hydraulic")'><h3>hydraulic</h3></span>
<span id='blockGen1002' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(210,217,240,0.8);' onclick='getPage("Robowars","Robowars_safety")'><h3>safety</h3></span>
<span id='blockGen1003' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(200,221,240,0.8);' onclick='getPage("Robowars","Robowars_judging")'><h3>judging</h3></span>
<span id='blockGen1004' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(229,233,219,0.8);' onclick='getPage("Robowars","Robowars_generalrules")'><h3>generalrules</h3></span>
<span id='blockGen1005' style='width:220px;padding: 15px;border-radius:20px;background: rgba(227,244,238,0.8);'><h3>Contact: Akshay K R <br/>koodlyakshay@gmail.com<br/>9731937661</h3></span>
</span>
</td>
<td style='width: 70%'>
...
Both on and off board power supplies are allowed. Batteries must be sealed, immobilized-electrolyte types (such as gel cells, lithium, NiCad, NiMH, or dry cells).</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The voltage between any two terminals in the robot should not exceed 25V. There is no restriction on the power consumption of the bot.</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >230V AC power will be provided.</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Participants can make use of one or more DC/Stepper motors.</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Use of an IC engine in any form is not allowed.</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If the robot is wired then the wire should remain slack under all circumstances during the competition. The length of the wire between controlling device &amp; the power supply and between machine &amp; controlling device should be at least 4 meters.</span><span id="blockGen1007" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
All robots must have easily visible and controlled mobility in order to compete.</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Any machine component should not be detached (intentionally) during any point of the war.</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The maximum power limitation for mobility is 150 W. However there is no power limitation for attack mechanism.</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Methods of Mobility include:</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Rolling (wheels, tracks or the whole robot)</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Walking (linear actuated legs with no rolling or cam operated motion).</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Shuffling(rotational cam operated legs)</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Jumping and hopping is not allowed</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Flying (airfoil using, helium balloons, ornithopters, hovercrafts etc.) is not allowed.</span><span id="blockGen1010" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Initial dimension of the robot should not exceed 50cm x 50cm x 50cm (l x b x h).The external device used to control the machine or any external tank is not included in the size constraint.</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Weight of the robot should not exceed 20kg (Excluding remote control and control wires).</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If the robot uses external pneumatic / hydraulic source tank, its weight would not be considered.</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If the robot is solely powered by onboard batteries (wireless robots), its weight would be considered 0.8 times its actual weight.</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The bot should contain an attack mechanism. Attack mechanism should be independent of the motion of the bot i.e. it should work even if the bot is motionless. A separate check of the attack mechanism will be conducted when the bot is immobile.</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The robot should have a small ground clearance such that the arena is not damaged at any point of time. The bot which causes any damage to arena will be disqualified.</span><span id="blockGen1013" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
The maximum duration of each battle would be 10 minutes except for the finals which is going to be a 20 minute battle. Any team that is not ready at the time specified will be disqualified from the competition and the opponent robot will be declared the winner.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >A robot that is deemed unsafe by the judges after the match has begun will be disqualified. The match will be immediately halted and the opponent will be awarded a win.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If the robots fail to contact each other for 60 seconds, both the robots will be eliminated.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The arena will have an opening through which bots can be pushed off the arena. </span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The robot will be declared victorious if it pushes the opponent off the arena through the opening in the wall twice.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case a robot falls off the arena or toppled during the match, it can be restored back to the start point by a team member, within 30 seconds, during which the opponent can move in the arena but not make contact with the other robot. Only 1 restore will be allowed per team.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The robot has to maintain a minimum distance of 60 cm from the opponent during its restore.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The robots are not allowed to cut the opponent&rsquo;s control wires. Violation of this rule will lead to disqualification.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case of immobility of any of the bots, both the bots will start again from their start points. </span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Pinning is allowed only in the specified pin zone and the points will be awarded only for first two pinning in the match. The bots again start from their start points.</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Prizes:</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 1st: Rs. 10,000</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 2nd: Rs. 7,000</span><span id="blockGen1016" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > 3rd: Rs. 5,000<br /><b>Schedule</b><br /> Day 2 (25) Sports complex
</span>
</span>
...
The arena will be a circular wooden board of diameter 8 ft. </span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The arena will have 3 ft high mesh all around it except an opening through which the robots can be pushed out of the arena </span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The arena may have one or more of the following traps:</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Reciprocating Platform with about 1 &ndash; 20 reciprocations per minute.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Rotating Platform of about 30 &ndash; 300 rpm.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Lifting Mechanisms.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Sand/Gravel/ Slush Pits of dimensions 70 cm x 70 cm. Depth of the pits from the arena surface are at an average of 3cm.&#160;</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Corrugations with a maximum radius of 10cm and pitch 20 cm.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Rollers with a maximum diameter of 6 cm.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Hitting Mechanisms.</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Heavy Oscillating Metal Balls</span><span id="blockGen1019" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
The competition will be played on knock-out basis.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The machine would be checked for its safety during registrations. In case of unsafe robots, the teams will be allowed to modify the robot before the registrations close.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Only one person can control the robot and one person can stay near the arena for monitoring the robot.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case of a tie, the robots will have to battle for a time duration of 2 minutes.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Each team will have a maximum time period of 20 minutes to repair their robot after each battle round.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The teams should make sure their wires are slack and all the wires coming out of robot need to be tangled together.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The wires coming out of the robot should be placed in such a way that it should be safe from any attacks on the bot and the attack mechanisms provided by the organizers. The organizers will not be held responsible in case of any accidents to the bot because of the attack mechanism provided.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The organizers reserve the right to change any or all of the above rules or add any rules as they deem fit.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Violation of any the above rules will lead to disqualification.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Judges' decision shall be treated as final and binding on all.</span><span id="blockGen1022" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
The bots must have at least one kind of attack mechanism. Defensive bots like Wedge bots will be disqualified.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Robots can have any kind of magnetic weapons, cutters, flippers, saws, lifting devices, spinning hammers etc. as weapons with following exceptions and limitations:</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Liquid projectiles.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Any kind of inflammable liquid.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Flame-based weapons.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Electro-Magnetic Pulse.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Any kind of explosive or intentionally ignited solid or potentially ignitable solid.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Nets, tape, glue, or any other entanglement device or adhesives.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >High power magnets or electromagnets.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Radio jamming, tazers, tesla coils, or any other high-voltage device.</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Un-tethered projectiles.&#160;</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Tethered projectiles in any direction with each having a maximum tether length of 1m are allowed.&#160;</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Spinning weapons which do not come in contact with the arena at no point of time are allowed. In no case should the arena be damaged by any bot. Violation of this rule will lead to immediate disqualification.&#160;</span><span id="blockGen1028" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Participants can use pneumatic and hydraulic weapon systems.</span><span id="blockGen1031" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The outlet pressure of the source/tank should not exceed 8 bars. The used pressure should be indicated by means of temporarily fitted pressure gauge or there should be a provision to measure the cylinder pressure on the bot.</span><span id="blockGen1031" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Robots can use pressurized, non-inflammable gases/liquid to initialize their pneumatic mechanisms.</span><span id="blockGen1031" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Teams have to bring their own cylinders. Organizers will not provide any kind of refilling.</span><span id="blockGen1031" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Weight of the external cylinders are not taken into account.</span><span id="blockGen1031" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Compliance with all event rules is mandatory. It is expected that competitors stay within the rules and procedures of their own accord and do not require constant policing.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >If you have a robot or weapon design that does not fit within the categories set forth in the above said rules or is in some way ambiguous or borderline, please contact the event organizers.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Safe innovation is always encouraged, but surprising the event staff with your brilliant exploitation of a loophole may cause your robot to be disqualified before it even competes.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Each event has safety inspections. It is at the judge&rsquo;s sole discretion that your robot is allowed to compete. As a builder you are obligated to disclose all operating principles and potential dangers to the inspection staff.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Proper activation and deactivation of robots is critical. Robots must only be activated in the arena, testing areas, or with express consent of the event coordinators.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >All weapons must have a safety cover on any sharp edges.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >All participants build and operate robots at their own risk. Combat robotics is inherently dangerous. There is no amount of regulation that can encompass all the dangers involved.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Please take care to not hurt yourself or others when building, testing and competing.</span><span id="blockGen1034" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Points will be awarded by the judges to a robot only if it has a considerable impact/damage on the opponent&rsquo;s robot. (Definition of damage will be decided by the judge and will be binding to all. NO discussion will be entertained)</span><span id="blockGen1037" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >In case none of the robots are completely damaged, the robot with maximum number of points will be declared the winner.</span><span id="blockGen1037" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >No points will be awarded for immobilizing the opponent bot.</span><span id="blockGen1037" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Points will be awarded for the team for using the offensive mechanisms provided by the organizers.</span><span id="blockGen1037" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
Contestants will have to register online. On spot registrations can also be done.</span><span id="blockGen1040" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The students must carry valid student ID cards of their college which they will be required to produce at the time of registration.</span><span id="blockGen1040" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >A team may comprise a maximum of FIVE participants.</span><span id="blockGen1040" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >A team can comprise of students from different colleges.</span><span id="blockGen1040" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >The team is not permitted to compete with more than one robot
</span>
</span>
...
<span id='blockGen1043' style='background: rgba(222,250,222,0.8);'><img src="static/Icons_Final/WrightFlight.png" width='250px'/></span><br />
<span id='blockGen1044' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,215,240,0.8);' onclick='register_single_event(31)'><h3>Register</h3></span>
<span id='blockGen1045' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(227,223,214,0.8);' onclick='getPage("wrightflight","wrightflight_Judging Criteria and Scoring")'><h3>Judging Criteria and Scoring</h3></span>
<span id='blockGen1046' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,229,207,0.8);' onclick='getPage("wrightflight","wrightflight_eventformat")'><h3>eventformat</h3></span>
<span id='blockGen1047' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(245,235,206,0.8);' onclick='getPage("wrightflight","wrightflight_generalrules")'><h3>generalrules</h3></span>
<span id='blockGen1048' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(249,248,213,0.8);' onclick='getPage("wrightflight","wrightflight_Glider Specifications")'><h3>Glider Specifications</h3></span>
<span id='blockGen1049' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(204,244,240,0.8);' onclick='getPage("wrightflight","wrightflight_Arena Specifications")'><h3>Arena Specifications</h3></span>
<span id='blockGen1050' style='width:220px;padding: 15px;border-radius:20px;background: rgba(210,201,202,0.8);'><h3>Contact: Akshay K R<br/>koodlyakshay@gmail.com <br/>9731937661</h3></span>
</span>
</td>
<td style='width: 70%'>
...
The following will be considered while judging the glider:</span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Preliminary Round &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - 40% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Gliding TEST) </span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/wft1.JPG'/></span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Final Round &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - 50% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Maneuverability TEST)</span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/wft2.JPG'/></span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Report &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - 10% </span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src='data/wft3.JPG'/></span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ></span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >Design & construction: More weightage for the glider with less weight to wingspan ratio. Minimum distance of 7 meters has to be covered by the glider in Preliminary round. </span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >*Safe landing for gliders with control surfaces is defined as landing under complete control of the plane and for uncontrolled planes it is decided based on the impact due to landing. </span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >*Glider is defined completely unpowered flying machine.</span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >(For more details check <a href="http://science.howstuffworks.com/transport/flight/modern/glider1.htm">here</a>) </span><span id="blockGen1052" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
&bull; In this event, contesting teams must build a Glider- an aerial reconnaissance vehicle.</span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; The glider must be unpowered. The glider can be either chucked by hand or a suitable mechanism can be built by the competing team for providing the initial thrust.</span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; A Hard copy of the report spanning one page has to be submitted by the teams on the day of the event regarding their glider construction procedure , materials used, design aspects etc , which will be the judging criteria of your glider in case of a tie. </span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; The event shall consist of 2 rounds - one preliminary and a final round.</span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; In the preliminary round, the participants are required to chuck the glider by hand to a maximum horizontal range and glide for the longest time period (Fig 1). </span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; The teams clearing the preliminary round qualify to the final round.</span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; In the final round, the teams are supposed to chuck their glider again by hand but here it is tested for maneuverability. The glider is required to go through a pre designated path and then maneuver across the given arena and crossing each checkpoint (Fig 2). </span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; Each team will be given THREE trials in each round and the best score from the three trials will be considered for the final scoring. </span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >&bull; The teams will have to bring their own radio control equipments (if using any) and the organizing committee won&rsquo;t be providing any.</span><span id="blockGen1055" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><a href='wrightflight.pdf'>Download</a>
</span>
</span>
...
Maximum wingspan of the glider must be 1.5 m.</span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Maximum weight of the glider should be less than 1kg.</span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Any material may be used for fabrication of glider.</span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Use of IC-engines in any form is not permitted. </span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > The initial thrust to the glider is provided by means of chucking by hand/a mechanism built by the </span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > team itself only.</span><span id="blockGen1061" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > Participants can use a maximum of 3 servo motors only for control surfaces.
</span>
</span>
...
The height of the building from which the participants will be launching their glider is 9 meters in and flight area of 35 m X 25 m. </span><span id="blockGen1064" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" ><img src = 'data/Wright_flight1.JPG'/> </span><span id="blockGen1064" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" > <img src = 'data/Wright_flight2.JPG'/> </span><span id="blockGen1064" style="width: 650px;font-size:20px;line-height:25px;background: rgba(255,255,255,0.8);padding: 10px;" >
</span>
</span>
...
<span id='blockGen1067' style='background: rgba(200,218,201,0.8);'><img src="static/Icons_Final/Beyond_Earth.png" width='250px'/></span><br />
<span id='blockGen1068' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(250,242,210,0.8);' onclick='register_single_event(46)'><h3>Register</h3></span>
<span id='blockGen1069' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,235,236,0.8);' onclick='getPage("BeyondEarth","BeyondEarth_Description")'><h3>Description</h3></span>
<span id='blockGen1070' style='width:220px;padding: 15px;border-radius:20px;background: rgba(205,239,242,0.8);'><h3>Contact: Mrinal Phone: 9449030636</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1075' style='background: rgba(246,241,236,0.8);'><img src="static/Icons_Final/starwars.png" width='250px'/></span><br />
<span id='blockGen1076' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,219,226,0.8);' onclick='register_single_event(47)'><h3>Register</h3></span>
<span id='blockGen1077' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(208,249,242,0.8);' onclick='getPage("StarWars","StarWars_Description")'><h3>Description</h3></span>
<span id='blockGen1078' style='width:220px;padding: 15px;border-radius:20px;background: rgba(240,231,202,0.8);'><h3>Contact: Mrinal Phone: 9449030636</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupStarWars">
<span id = "tabsStarWars_Description">
<span id="blockGen1079" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen1082" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
</span>
</span>
</td>
...
<span id='blockGen1083'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(209,208,239,0.8);'><h1 style='text-align:center;font-family: acens;'>Exhibits</h1></button></span><br />
<span id='blockGen1084' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(220,233,222,0.8);' onclick='register_single_event(48)'><h3>Register</h3></span>
<span id='blockGen1085' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(221,241,237,0.8);' onclick='getPage("Exhibits","Exhibits_Description")'><h3>Description</h3></span>
<span id='blockGen1086' style='width:220px;padding: 15px;border-radius:20px;background: rgba(216,203,216,0.8);'><h3>Contact: Mrinal Phone: 9449030636</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1091' style='background: rgba(226,221,220,0.8);'><img src="static/Icons_Final/astro_talk.png" width='250px'/></span><br />
<span id='blockGen1092' class="register" style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(206,248,217,0.8);' onclick='register_single_event(49)'><h3>Register</h3></span>
<span id='blockGen1093' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(226,234,203,0.8);' onclick='getPage("AstroTalk","AstroTalk_Description")'><h3>Description</h3></span>
<span id='blockGen1094' style='width:220px;padding: 15px;border-radius:20px;background: rgba(229,241,227,0.8);'><h3>Contact: Mrinal Phone: 9449030636</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1099' style='background: rgba(226,249,220,0.8);'><img src="static/Icons_Final/PsychRoom.png" width='250px'/></span><br />
<span id='blockGen1100' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(213,204,214,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room_Decagon")'><h3>Decagon</h3></span>
<span id='blockGen1101' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(248,211,219,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room_Light_Wall")'><h3>Light_Wall</h3></span>
<span id='blockGen1102' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(238,226,249,0.8);' onclick='getPage("Psychedelic_Room","Psychedelic_Room_Waterfall")'><h3>Waterfall</h3></span>
<span id='blockGen1103' style='width:220px;padding: 15px;border-radius:20px;background: rgba(201,234,219,0.8);'><h3>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1113'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(202,212,249,0.8);'><h1 style='text-align:center;font-family: acens;'>Dance Dance Revolution</h1></button></span><br />
<span id='blockGen1114' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(211,236,207,0.8);' onclick='getPage("Dance_Dance_Revolution","Dance_Dance_Revolution_Description")'><h3>Description</h3></span>
<span id='blockGen1115' style='width:220px;padding: 15px;border-radius:20px;background: rgba(231,240,218,0.8);'><h3>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1119'><button class='button1' style='border-radius: 0%;width: 250px;height: 250px;background: rgba(221,217,248,0.8);'><h1 style='text-align:center;font-family: acens;'>Arcade Room</h1></button></span><br />
<span id='blockGen1120' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(235,225,208,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_ContraptioN")'><h3>ContraptioN</h3></span>
<span id='blockGen1121' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(247,201,220,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Liquid_Light")'><h3>Liquid_Light</h3></span>
<span id='blockGen1122' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(240,240,216,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Temple_Run")'><h3>Temple_Run</h3></span>
<span id='blockGen1123' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(205,233,242,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Theremin")'><h3>Theremin</h3></span>
<span id='blockGen1124' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(231,201,220,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Pin_Ball")'><h3>Pin_Ball</h3></span>
<span id='blockGen1125' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(209,230,227,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Agent_Dash")'><h3>Agent_Dash</h3></span>
<span id='blockGen1126' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(216,219,222,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Shadow_LED")'><h3>Shadow_LED</h3></span>
<span id='blockGen1127' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(241,236,212,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Strongman")'><h3>Strongman</h3></span>
<span id='blockGen1128' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(222,230,217,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Labyrinth")'><h3>Labyrinth</h3></span>
<span id='blockGen1129' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(237,230,223,0.8);' onclick='getPage("Arcade_Room","Arcade_Room_Laser_Harp")'><h3>Laser_Harp</h3></span>
<span id='blockGen1130' style='width:220px;padding: 15px;border-radius:20px;background: rgba(223,237,248,0.8);'><h3>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
<span id = "tabgroupArcade_Room">
<span id = "tabsArcade_Room_ContraptioN">
<span id="blockGen1131" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen1137" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen1140" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen1143" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id="blockGen1146" style='width: 650px;font-size:25px;line-height:30px;background: rgba(255,255,255,0.8);padding: 15px;'>
</span>
...
<span id='blockGen1161' style='background: rgba(230,208,220,0.8);'><img src="static/Icons_Final/blitzkrieg.png" width='250px'/></span><br />
<span id='blockGen1162' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(233,237,227,0.8);' onclick='getPage("Blitzkrieg","Blitzkrieg_Description")'><h3>Description</h3></span>
<span id='blockGen1163' style='width:220px;padding: 15px;border-radius:20px;background: rgba(212,235,236,0.8);'><h3>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
...
<span id='blockGen1167' style='background: rgba(201,209,229,0.8);'><img src="static/Icons_Final/megapixel.png" width='250px'/></span><br />
<span id='blockGen1168' style='width:220px;padding: 5px;padding-left: 15px;padding-right: 15px;cursor: pointer;border-radius:20px;background: rgba(234,217,204,0.8);' onclick='getPage("Megapixel","Megapixel_Description")'><h3>Description</h3></span>
<span id='blockGen1169' style='width:220px;padding: 15px;border-radius:20px;background: rgba(209,206,250,0.8);'><h3>Contact: Jacob(8123464539): <br/> jacobv1992@gmail.com</h3></span>
</span>
</td>
<td style='width: 70%'>
