...
Mechanical={
"Robowars": {"image":"./Icons_Final/RoboWars.png","contact":"Akshay K R <br/>koodlyakashay@gmail.com","generalrules":"&bull; Contestants will have to register online. On spot registrations can also be done.<br/>&bull; The students must carry valid student ID cards of their college which they will be required to produce at the time of registration.<br/>&bull; A team may comprise a maximum of FIVE participants.<br/>&bull; A team can comprise of students from different colleges.<br/>\
&bull; The team is not permitted to compete with more than one robot.","eventformat": "&bull; The competition will be played on knock-out basis.<br/>\
&bull; The machine would be checked for its safety during registrations. In case of unsafe \
robots, the teams will be allowed to modify the robot before the registrations close.<br/>\
&bull; Only one person can control the robot and one person can stay near the arena for \
monitoring the robot.<br/>\
&bull; In case of a tie, the robots will have to battle for a time duration of 2 minutes.<br/>\
&bull; Each team will have a maximum time period of 20 minutes to repair their robot after \
each battle round.<br/>\
&bull; The teams should make sure their wires are slack and all the wires coming out of robot \
need to be tangled together.<br/>\
&bull; The wires coming out of the robot should be placed in such a way that it should be safe \
from any attacks on the bot and the attack mechanisms provided by the organizers. The \
organizers will not be held responsible in case of any accidents to the bot because of the \
attack mechanism provided.<br/>\
