...
"Rectify":{"image": "engineer.gif","contact": "contact","Description": "It’s time to scratch your Grey cells, it’s time to rectify! Rectify will test your hunting instincts. Can\
...
"Marathon":{"image": "./Icons_Final/marathon_final.png","contact": "contact","Description": "Marathon is an event that inculcates multiple tasks of varying difficulty covering all fields of\
...
"ECTF_-_Capture_the_Flag":{"image": "./Icons_Final/ECTF.png","contact": "contact","Description": "ECTF is a ethical hacking competition, where you set up your Base (a virtual machine) with the\
...
"Virtual_Bounty":{"image": "./Icons_Final/VIRTUAL_BOUNTY2.png","contact": "contact","Description": "Virtual Bounty is the online technical treasure hunt of Engineer, where the divine 'Googling' skills\
...
"TrailBlazer":{"image": "./Icons_Final/ trailblazer.png","contact": "contact","Description": "<b>Description:</b><br/>noun /ˈtrālˌblāzər/<br/>\
...
Get on the codes of Samuel Morse, decode the ‘dits and dahs’ and ace the event.<br/>A simple event based on line follower robotics.\
 ...
 <b>Objective</b><br/><ul><li>\
The goal of the robot is to traverse the path from the start point to the end and decode the Morse codes in different locations and finally display the sum.</li>\
<li>The sum will be less than 100.</li><li>The sum can be displayed on a seven segment display, LCD display or using leds (in BCD format).</li></ul><br/>\
<B>ARENA SPECIFICATIONS</B><BR/>\
To be decided.<br/><br/><B>ROBOT SPECIFICATIONS</B><BR/><ul><li>The robot should be completely autonomous and self contained; external computers not allowed.</li>\
...
<b>Test Run on Sunday(21st Oct) 1500 - 1800 (IST)<br/>\
Main Event on Monday(22nd Oct) 1500 - 2400 (IST)</b><br/>\
<B>EVENT FORMAT</B><BR/>\
...
"Trade_OFF":{"image": "engineer.gif","contact": "contact","Description": "<b>Trade-off </b>:n.\ˈtrād-ˌȯf\ : A trade-off (or tradeoff) is a situation that involves losing<br/>one quality or aspect of something in return for gaining another quality or aspect.<br/>\
...
"FoxHunt":{"image": "./Icons_Final/foxxhunt.png","contact": "contact","Description": "“In the new era, thought itself will be transmitted by radio.” --Guglielmo Marconi<br/><br/>\
...
"HR_Event":{"image": "./Icons_Final/MBA.png","contact": "contact","Description": "<b>ROUND1 –CASE STUDY</b><br/>\
...
<br/>The team which spends the most will get the best employee but loses points.<br/>\
NOTE: Bidding of same team members not allowed<br/><br/>\
<b>ROUND 3-EXTEMPORE</b><br/>\
<br/>Now with the new partners there will be an extempore in which on the spot problem solving skills will be checked,<br/>by giving them some real life crises situations.<br/>\
Team will be selected randomly on to stage.<br/>\
Judges will be evaluating based on the performance of team.<br/>\
Results declared-<br/>\
The top 4 teams having highest points will be promoted to next round and the rest of the teams will be eliminated.<br/>\
<b>ROUND 4-OVERNIGHT CASE STUDY</b><br/>\
4 teams selected, each team will be given an overnight case study, and they have to give a presentation on it next day.<br/>\
In the morning there will be a presentation of case study by each team in front of the judges which is evaluated by them.<br/>\
Other teams are also provided opportunity to ask questions related to case to the team that’s presenting.<br\>\
Maximum points will be 100<br\>\
<br/><b>ROUND 5-INTERVIEW</b><br/>\
 Interview will be conducted by these teams, which will be monitored by judges, each team will take interview of other team.<br/>\
They have to test the interviewee on the basis of these criteria:-<br/>\
1)	Logical & Analytical Skill<br/>\
2)	CSR<br/>\
3)	Leadership & Motivation<br/>\
4)	Innovative<br/>\
5)	How to handle situation of crisis.<br/>Each team will be given 40 minutes to frame these questions and also prepare for interview,<br/>as the questions will be monitored by the judges.<br/>  \
Points will be given based on your performance as INTERVIEWER and INTERVIEWEE<br/>\
The team with maximum points is the overall winner<br/>\
Time estimation<br/>\
1)	Case study- (11:00AM)<br/>\
Distribution -30 min<br/>\
Presentation- 2-3 min to each team<br/>\
Lunch – (12:00PM)<br/>\
<br/>\
2)	Hidden bidding-(2:00PM)<br/>\
Preparation of intro-10 min<br/>\
Presenting the Intro-5 min per employee<br/>\
Bidding procedure -30 min<br/>\
<br/>\
3)	Team event of new team formed(4:30PM)<br/>\
Presentation- 5min per team<br/>\
On 25th by 5:30pm all the events will be completed and results will be given within 15min<br/>\
Explanation of overnight case study- 20 min.<br/>\
<br/><br/>\
<b>Day 2</b><br/>\
4) PPT-(9:00AM)<br/>\
Presentation-max 20 min per team<br/>\
5) Interview- (11:00AM)<br/>\
20 min per team.<br/>\
So the event comes to end by 1:30 and results will be declared ASAP.<br/>\
"},

"Finance_Event":{"image": "./Icons_Final/Finance.png","contact": "contact","Description": "<b>\
Round 1<br/>\
...
arena, testing areas, or with express consent of the event coordinators. All weapons must have a safety cover on any sharp edges.\
 ...
 "PerfectMachine":{"image":"engineer.gif","contact":"contact","generalrules":" The students must carry valid student ID cards of their college which they will be required to \
...
points on the bot must not exceed 24 V DC or 24 V AC.","mobility":"All robots must have easily visible and controlled mobility in order to compete. \
 ...
 "wrightflight":{"image":"engineer.gif","contact":"contact","generalrules":"Contestants will have to register online. On spot registrations can also be done.\
...
Arrows indicate designated flying zone"},

 "Proteus":{"image": "engineer.gif","contact": "contact","generalrules":" Participants must carry valid ID cards of their respective college, which must be produced at the time of registration.\
