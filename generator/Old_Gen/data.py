...
We will get back to you with further details. Stay updated. <br/>","contact"],

"The_Portal":["engineer.gif","<b>Introduction:</b><br/><br/>\
...
This will be followed up by an exciting event based on software.<br/> Hurry up! Limited Seats! Lots of prizes at stake.<br/>","contact"],
...
"Trade_OFF":["engineer.gif","<b>Trade-off </b>:n.\ˈtrād-ˌȯf\ : A trade-off (or tradeoff) is a situation that involves losing<br/>one quality or aspect of something in return for gaining another quality or aspect.<br/>\
...
"The_Last_Word":["engineer.gif","Description: The final event to take place during Engineer,<br/>The Last Word is an engaging panel discussion that calls upon eminent personalities to explore a pressing issue which society faces today.<br/>\
<br/>\
...
"Sparsh":["engineer.gif","<b>Description:</b>  Sparsh calls upon teams to design and develop a solution to a problem faced by local communities.<br/>The participants are required to make a presentation putting forth their ideas and their proposals<br/>for the given problem statement. SPARSH stands out from the rest of the events in the<br/>sense that the team SPARSH will continue to be a part of the project and the implementation<br/>of the solutions even after Engineer comes to an end and continue its technical support to the organization.<br/>\
<br/>\
Budget:<br/>\
...
"Sky_Lanterns":["engineer.gif","<b>Description:</b> Chief Guest may light sky lanterns along with students and dignitaries<br/>\
Budget: Rs.  4000<br/>\
Venue: Main ground after inauguration<br/>\
","contact"],

"Green_Design_Challenge":["engineer.gif","<b>Description:</b> SCE along with business events committee will be evaluating 'green' innovation ideas based <br/>on their business feasibility and environmental impact.<br/>","contact"],
...
"Adverse_Mining_Problem":["engineer.gif","This is a power point presentation round where the participants can choose a real-life industry problem (ex: neyveli / kgf) and discuss the problem and come up with the best possible feasible solution(s).  judgment  will be done by the experts. <br />\
Time : 14:00-16:00<br />\
...
","Arjun Thumbayil - arjunthumbayil@hotmail.com"],

"Innovating_Mining":["engineer.gif","Students are allowed to think without any bounds on creative grounds to come up with mining techniques that are non-conventional and of-course are safe and economical as well as practically feasible. this will be a power-point presentation round.<br />\
time : 09:30-11:00<br />\
venue : mining department (conference hall)<br />\
net prize money :  rs.2000/-<br />\
","Arjun Thumbayil - arjunthumbayil@hotmail.com"],

"Blast_Mine_Ventilation":["engineer.gif","A very simple round in which the participants will be given the required data pertaining to blasting/ ventilation and where in the participants are required to design a suitable layout for the same. judgment to be done by experts.<br />\
time : 11:00-12:00<br />\
venue : mining department (conference hall)<br />\
net prize money :  rs.2000/-<br />\
","Arjun Thumbayil - arjunthumbayil@hotmail.com"],
"Hang-Man":["engineer.gif","This round is based on the actual hangman game where the participants will be given a picture and is required to guess the title or relevant data as per the question posed to them.<br />\
time : 14:00-15:00<br />\
venue : mining department (conference hall)<br />\
net prize money :  rs.2000/-<br />\
","Arjun Thumbayil - arjunthumbayil@hotmail.com"],
