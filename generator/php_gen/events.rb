...
$no_registrations=["Sky_Lanterns","Tech_Speak","Psychedelic_Room","Blitzkrieg","Megapixel","Dance_Dance_Revolution","Arcade_Room","Mockstock","Case_Study_challenge","Simplineer","Inscription"]
def get_num()
	$num+=1
	return $num.to_s
end
