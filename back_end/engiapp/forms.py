...
class TeamRegistrationForm(forms.Form):
    ...
    event_id = forms.IntegerField(label=u'Event Id')
...
#            team_event=EngiEvents.objects.get(id=event_id)
#        except EngiEvents.DoesNotExist():
#            raise forms.ValidationError("Team exists for this event")
#        return event_id
#
...
#            event_id=self.cleaned_data['event_id']
#            team_event=EngiEvents.objects.get(id=event_id)
#            team=Team.objects.get(team_name=team_name,team_event=team_event)
